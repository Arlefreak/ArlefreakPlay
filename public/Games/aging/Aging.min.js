...
}if(s.cacheAlpha!=s.worldAlpha){s.cacheAlpha=s.worldAlpha;var x=4*r;this.colors[x]=this.colors[x+1]=this.colors[x+2]=this.colors[x+3]=s.worldAlpha,this.dirtyColors=!0}}else k=8*r,this.verticies[k+0]=0,this.verticies[k+1]=0,this.verticies[k+2]=0,this.verticies[k+3]=0,this.verticies[k+4]=0,this.verticies[k+5]=0,this.verticies[k+6]=0,this.verticies[k+7]=0;r++,s=s.__next}},e});var Aging={};Aging.Boot=function(){},Aging.Boot.prototype={preload:function(){this.load.image("preloaderBarBack","assets/img/loading-bar-background.png"),this.load.image("preloaderBar","assets/img/loading-bar.png"),this.load.image("name","assets/img/letrero.png")},create:function(){this.game.input.maxPointers=1,this.game.stage.disableVisibilityChange=!0,this.game.device.desktop?this.game.stage.scale.pageAlignHorizontally=!0:(this.game.stage.scaleMode=Phaser.StageScaleMode.SHOW_ALL,this.game.stage.scale.minWidth=480,this.game.stage.scale.minHeight=260,this.game.stage.scale.maxWidth=1024,this.game.stage.scale.maxHeight=768,this.game.stage.scale.forceLandscape=!0,this.game.stage.scale.pageAlignHorizontally=!0,this.game.stage.scale.setScreenSize(!0)),this.game.state.start("Preloader")}},Aging.Preloader=function(){this.background=null,this.preloadBar=null,this.ready=!1},Aging.Preloader.prototype={preload:function(){this.game.stage.backgroundColor="#333333";this.add.sprite(this.world.centerX-188.5,20,"name");this.preloadBar=this.add.sprite(this.world.centerX-165,this.world.centerY,"preloaderBarBack"),this.preloadBar=this.add.sprite(this.world.centerX-165,this.world.centerY,"preloaderBar"),this.load.setPreloadSprite(this.preloadBar),this.load.image("city_day","assets/textures/city_d.png"),this.load.image("city_night","assets/textures/city_n.png"),this.load.image("sky_day","assets/img/sky10x600.png"),this.load.image("sky_night","assets/img/sky_n10x600.png"),this.load.image("tutorial","assets/img/tutorial.png"),this.load.image("heart","assets/img/heart.png"),this.load.image("barra","assets/img/barra5x55.png"),this.load.image("subfloor_day","assets/textures/tierra_d80x80.png"),this.load.image("subfloor_night","assets/textures/tierra_n80x80.png"),this.load.image("sidewalk_day","assets/textures/cemento_d160x24.png"),this.load.image("sidewalk_night","assets/textures/cemento_n160x24.png"),this.load.image("bushes_day","assets/textures/arbustos_d.png"),this.load.image("bushes_night","assets/textures/arbustos_n.png"),this.load.image("land_day","assets/textures/land_d.png"),this.load.image("land_night","assets/textures/land_n.png"),this.load.image("bg_main_menu","assets/img/state0.png"),this.load.image("can","assets/textures/obstaculo50x50_1.png"),this.load.image("poop","assets/textures/obstaculo50x50_3.png"),this.load.image("trash","assets/textures/obstaculo50x50_2.png"),this.load.image("vCollide","assets/textures/vCollide.png"),this.load.image("hCollide","assets/textures/hCollide.png"),this.load.image("calendar","assets/img/calendario.png"),this.load.atlasJSONHash("guy","assets/sprites/guy_.png","assets/sprites/guy_.json"),this.load.atlasJSONHash("trees","assets/sprites/trees.png","assets/sprites/trees.json"),this.load.atlasJSONHash("botones","assets/sprites/botones_.png","assets/sprites/botones_.json"),this.load.audio("ambient",["assets/audio/Ambient A Zyow.mp3","assets/audio/Ambient A Zyow.ogg"])},create:function(){this.preloadBar.cropEnabled=!1},update:function(){this.cache.isSoundDecoded("ambient")&&0==this.ready&&(this.ready=!1,this.game.state.start("MainMenu"))}},Aging.MainMenu=function(){this.music=null,this.playButton=null,this.audioStatus=!0},Aging.MainMenu.prototype={create:function(){var a=(this.add.sprite(0,0,"bg_main_menu"),this.add.sprite(100,220,"tutorial"),this.game.input.keyboard.addKey(Phaser.Keyboard.ENTER));a.onDown.add(this.startGame,this);this.add.sprite(this.world.centerX-188.5,20,"name");button=this.add.button(this.world.centerX-55,this.world.centerY+200,"botones",this.startGame,this,"play02","play01","play03")},startGame:function(){this.game.state.start("Game")}},Aging.Game=function(){this.game,this.add,this.camera,this.cache,this.input,this.load,this.math,this.sound,this.stage,this.time,this.tweens,this.world,this.particles,this.physics,this.rnd,this.music,this.land_day,this.land_night,this.city_day,this.city_night,this.sidewalk_day,this.sidewalk_night,this.bushes_day,this.bushes_night,this.subfloor_day,this.subfloor_night,this.sky_day,this.sky_night,this.floor,this.tutorial,this.gFloors,this.gTrees,this.gBoxes,this.gHearts,this.guy,this.box,this.box2,this.box3,this._jump,this.gravity,this.velocity,this.slowVelocity,this.mediumVelocity,this.contadorbox,this.score,this.score_text,this.lives_text,this.birthday_text,this.frameC,this.playingMusic,this.dead,this.upKey,this.touchPointer,this.muteKey,this.pauseKey,this.enterKey,this.bttRetry,this.bttPlay,this.bttPause,this.bttMute},Aging.Game.prototype={Guy:function(a,b,c,d,e,f,g,h,i,j){this.game=a,this.lives=i,this.birthday=new Date,this.age=j,this.alive=!0,this.s=a.add.sprite(b,c,e),this.s.name=d,this.s.body.collideWorldBounds=f,this.s.body.gravity.y=g,this.s.body.maxVelocity.y=h,this.s.body.immovable=!1,this.s.body.setSize(60,90,20,0),this.s.animations.add("krun",Phaser.Animation.generateFrameNames("kcorrer_",1,10,"",2),60,!0),this.s.animations.add("jrun",Phaser.Animation.generateFrameNames("jcorrer_",1,10,"",2),60,!0),this.s.animations.add("vrun",Phaser.Animation.generateFrameNames("vcorrer_",1,26,"",2),60,!0),this.s.animations.add("kjump",Phaser.Animation.generateFrameNames("ksaltar_",1,6,"",2),60,!0),this.s.animations.add("jjump",Phaser.Animation.generateFrameNames("jsaltar_",1,6,"",2),60,!0),this.s.animations.add("vjump",Phaser.Animation.generateFrameNames("vsaltar_",1,11,"",2),60,!0),this.s.animations.play("krun",13,!0)},Box:function(a,b,c,d,e,f,g){this.game=a,this.s=gBoxes.create(b,c,e,this.game.rnd.integerInRange(0,36)),this.s.name=d,this.s.body.immovable=f,this.s.body.velocity.x=g},BgAsset:function(a,b,c,d,e,f){this.city=this.add.tileSprite(a,b,c,d,e),this.city.body.velocity.x=f},Tree:function(a,b,c,d,e){return this.tree=gTrees.create(a,b,c,e,!0),this.tree.body.velocity.x=d,this.tree},create:function(){playingMusic=!0,dead=!1,contadorbox=0,score=0,velocity=-400,slowVelocity=-10,mediumVelocity=-20,gravity=12,_jump=1,frameC=0,music=this.game.add.audio("ambient",1,!0),music.play("",0,1,!0),floor=this.add.sprite(this.game.world.centerX-200,this.game.world.height-94,"vCollide"),sky_night=this.add.tileSprite(0,0,1e4,600,"sky_night"),sky_day=this.add.tileSprite(0,0,1e4,600,"sky_day"),land_night=this.add.tileSprite(2,50,1e4,458,"land_night"),land_day=this.add.tileSprite(0,50,1e4,458,"land_day"),city_night=this.add.tileSprite(2,50,1e4,458,"city_night"),city_day=this.add.tileSprite(0,50,1e4,458,"city_day"),gTrees=this.game.add.group();this.Tree(1e4*Math.random(),180,"trees",velocity,"arbol01_d.png"),this.Tree(1e4*Math.random(),120,"trees",velocity,"arbol03_d.png"),this.Tree(1e4*Math.random(),140,"trees",velocity,"arbol04_d.png"),this.Tree(1e4*Math.random(),180,"trees",velocity,"arbol05_d.png"),this.Tree(1e4*Math.random(),120,"trees",velocity,"arbol06_d.png");subfloor_night=this.add.tileSprite(0,this.game.world.height-80,1e5,80,"subfloor_night"),subfloor_day=this.add.tileSprite(0,this.game.world.height-80,1e5,80,"subfloor_day"),sidewalk_night=this.add.tileSprite(0,this.game.world.height-94,1e5,24,"sidewalk_night"),sidewalk_day=this.add.tileSprite(0,this.game.world.height-94,1e5,24,"sidewalk_day"),bushes_night=this.add.tileSprite(0,this.game.world.height-180,1e5,86,"bushes_night"),bushes_day=this.add.tileSprite(0,this.game.world.height-180,1e5,86,"bushes_day");this.add.tileSprite(0,0,1e3,55,"barra");bttPause=this.add.button(this.world.width-110,5,"botones",this.managePause,this,"pausa45x45_2","pausa45x45_1","pausa45x45_3"),bttMute=this.add.button(this.world.width-175,5,"botones",this.manageSound,this,"sonido45x45_2","sonido45x45_1","sonido45x45_3"),this.add.sprite(20,5,"calendar"),guy=new this.Guy(this.game,this.game.world.centerX-200,396,"guy","guy",!0,gravity,300,3,10),gBoxes=this.game.add.group(),box=new this.Box(this.game,this.game.world.width+50,this.game.world.height-144,"Box"+contadorbox,"trash",!0,velocity),box2=new this.Box(this.game,2*(this.game.world.width+50),this.game.world.height-144,"Box"+contadorbox,"poop",!0,velocity),box3=new this.Box(this.game,3*(this.game.world.width+50),this.game.world.height-144,"Box"+contadorbox,"can",!0,velocity),floor.body.immovable=!0,gHearts=this.game.add.group();var a=this.add.sprite(200,5,"heart"),b=this.add.sprite(270,5,"heart"),c=this.add.sprite(350,5,"heart");gHearts.add(c),gHearts.add(b),gHearts.add(a);for(var d=0;d>=guy.lives;d++)gHearts.create(300+10*d,100+200*Math.random(),"heart");upKey=this.game.input.keyboard.addKey(Phaser.Keyboard.UP),pauseKey=this.game.input.keyboard.addKey(Phaser.Keyboard.P),muteKey=this.game.input.keyboard.addKey(Phaser.Keyboard.M),enterKey=this.game.input.keyboard.addKey(Phaser.Keyboard.ENTER),touchPointer=this.game.input.pointer1,upKey.onDown.add(this.resetJump,this),pauseKey.onDown.add(this.managePause,this),pauseKey.onDown.add(this.resetJump,this),muteKey.onDown.add(this.manageSound,this),enterKey.onDown.add(this.manageEnter,this),this.game.input.onDown.add(this.resetJump,this),this.add.tween(sky_day).to({alpha:0},1e4,Phaser.Easing.Linear.None,!0,0,1e4,!0),this.add.tween(land_day).to({alpha:0},1e4,Phaser.Easing.Linear.None,!0,0,1e4,!0),this.add.tween(city_day).to({alpha:0},1e4,Phaser.Easing.Linear.None,!0,0,1e4,!0),this.add.tween(sidewalk_day).to({alpha:0},1e4,Phaser.Easing.Linear.None,!0,0,1e4,!0),this.add.tween(subfloor_day).to({alpha:0},1e4,Phaser.Easing.Linear.None,!0,0,1e4,!0),this.add.tween(bushes_day).to({alpha:0},1e4,Phaser.Easing.Linear.None,!0,0,1e4,!0);var e="Score: ",f={font:"20px Arial",fill:"#333333",align:"center"};score_text=this.add.text(450,30,e,f);var g=guy.birthday.getFullYear(),f={font:"20px Arial",fill:"#333333",align:"center"};birthday_text=this.add.text(35,30,g,f),tutorial=this.add.sprite(0,-100,"tutorial"),tutorial.alpha=0},update:function(){land_night.body.velocity.x=slowVelocity,land_day.body.velocity.x=slowVelocity,city_night.body.velocity.x=mediumVelocity,city_day.body.velocity.x=mediumVelocity,gTrees.setAll("body.velocity.x",velocity),sidewalk_night.body.velocity.x=velocity,sidewalk_day.body.velocity.x=velocity,subfloor_day.body.velocity.x=velocity,subfloor_night.body.velocity.x=velocity,bushes_day.body.velocity.x=velocity,bushes_night.body.velocity.x=velocity,guy.s.body.x=this.game.world.centerX-200,frameC++,this.Score(),upKey.isDown||touchPointer.isDown?_jump>=0&&this.jump():_jump=-1,console.log(guy.age),this.checkBox(),this.checkTree(),this.game.physics.collide(guy.s,box.s,this.collisionHandler,null,this),this.game.physics.collide(guy.s,box2.s,this.collisionHandler,null,this),this.game.physics.collide(guy.s,box3.s,this.collisionHandler,null,this),this.game.physics.collide(guy.s,floor,this.collisionHandler,null,this)},render:function(){},quitGame:function(){this.game.state.start("MainMenu")},Score:function(){dead||(250==frameC&&(score++,this.newYear(),frameC=0),score_text.setText("Score: "+score),birthday_text.setText(guy.birthday.getFullYear()+(guy.age-10)))},resetJump:function(){_jump=0},jump:function(){_jump+=this.game.time.physicsElapsed,_jump>.3&&(_jump=-1),guy.s.y-=7,guy.age<20?guy.s.animations.play("kjump",14,!0):guy.age<40&&guy.age>=20?guy.s.animations.play("jjump",14,!0):guy.age>=40&&guy.s.animations.play("vjump",20,!0)},collisionHandler:function(a,b){if(b==floor)guy.age<20?guy.s.animations.play("krun",13,!0):guy.age<40&&guy.age>=20?guy.s.animations.play("jrun",13,!0):guy.age<90&&guy.age>=40?guy.s.animations.play("vrun",20,!0):guy.age>=90&&this.die(a,!0);else if(b.body.touching.left)if(guy.lives--,0==guy.lives)this.die(a,!1);else{console.log(a.name+" collided with: "+b.name),b.kill(),guy.s.alpha=0;var c=gHearts.getFirstAlive();c&&c.kill(),this.game.add.tween(guy.s).to({alpha:1},20,Phaser.Easing.Linear.None,!0,0,1e5,!1),b.revive(),b.x=this.game.world.width+100+this.game.world.randomX}else console.log(a.name+" collided with "+b.name)},die:function(a,b){if(dead=!0,b)var c="You win! \n Score: "+score,d={font:"65px Arial",fill:"#e3e3e3",align:"center"},e=this.add.text(this.world.centerX,this.world.centerY,c,d);else var c="You died \n Score: "+score,d={font:"65px Arial",fill:"#e3e3e3",align:"center"},e=this.add.text(this.world.centerX,this.world.centerY,c,d);a.destroy(),box.s.destroy(),box2.s.destroy(),box3.s.destroy(),velocity=0,slowVelocity=0,mediumVelocity=0,e.anchor.setTo(.5,.5),music.pause(),bttRetry=this.add.button(this.world.centerX-55,this.world.centerY+100,"botones",this.reStart,this,"replay01","replay02","replay03")},reStart:function(){this.game.state.start("Game")},checkBox:function(){box.s.x<=-50&&(box.s.revive(),box.s.x=this.game.world.width+box3.s.x-this.game.world.randomX,contadorbox++,score++),box2.s.x<=-50&&(box2.s.revive(),box2.s.x=this.game.world.width+box.s.x-this.game.world.randomX,contadorbox++,score++),box3.s.x<=-50&&(box3.s.revive(),box3.s.x=this.game.world.width+box2.s.x-this.game.world.randomX,contadorbox++,score++)},checkTree:function(){gTrees.x<=-1&&(console.log("Trees: "+gTrees.x),gTrees.x=-750)},managePause:function(){this.game.paused=this.game.paused?!1:!0},manageSound:function(){playingMusic?(bttMute.setFrames("mute45x45_2","mute45x45_1","mute45x45_3"),music.pause()):(bttMute.setFrames("sonido45x45_2","sonido45x45_1","sonido45x45_3"),music.resume()),playingMusic=!playingMusic},manageEnter:function(){(this.game.paused||dead)&&(this.game.paused=!1,this.reStart(),console.log("test"))},newYear:function(){guy.age++}};
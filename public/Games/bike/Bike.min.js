...
e.data=f,b.push(e)}return b}},d.Tileset=function(a,b,c,d,e,f){"undefined"==typeof e&&(e=0),"undefined"==typeof f&&(f=0),this.key=b,this.image=a,this.tileWidth=c,this.tileHeight=d,this.margin=e,this.spacing=f,this.tiles=[]},d.Tileset.prototype={addTile:function(a){return this.tiles.push(a),a},getTile:function(a){return this.tiles[a]?this.tiles[a]:null},setSpacing:function(a,b){this.tileMargin=a,this.tileSpacing=b},canCollide:function(a){return this.tiles[a]?this.tiles[a].collideNone:null},checkTileIndex:function(a){return this.tiles[a]},setCollisionRange:function(a,b,c,d,e,f){if(this.tiles[a]&&this.tiles[b]&&b>a)for(var g=a;b>=g;g++)this.tiles[g].setCollision(c,d,e,f)},setCollision:function(a,b,c,d,e){this.tiles[a]&&this.tiles[a].setCollision(b,c,d,e)}},Object.defineProperty(d.Tileset.prototype,"total",{get:function(){return this.tiles.length}}),c.CanvasRenderer.prototype.render=function(a){c.texturesToUpdate.length=0,c.texturesToDestroy.length=0,c.visibleCount++,a.updateTransform(),this.context.setTransform(1,0,0,1,0,0),this.context.clearRect(0,0,this.width,this.height),this.renderDisplayObject(a),c.Texture.frameUpdates.length>0&&(c.Texture.frameUpdates.length=0)},c.CanvasRenderer.prototype.renderDisplayObject=function(a){var b=a.last._iNext;a=a.first;do if(a.visible)if(a.renderable&&0!==a.alpha){if(a instanceof c.Sprite)a.texture.frame&&(this.context.globalAlpha=a.worldAlpha,a.texture.trimmed?this.context.setTransform(a.worldTransform[0],a.worldTransform[3],a.worldTransform[1],a.worldTransform[4],a.worldTransform[2]+a.texture.trim.x,a.worldTransform[5]+a.texture.trim.y):this.context.setTransform(a.worldTransform[0],a.worldTransform[3],a.worldTransform[1],a.worldTransform[4],a.worldTransform[2],a.worldTransform[5]),this.context.drawImage(a.texture.baseTexture.source,a.texture.frame.x,a.texture.frame.y,a.texture.frame.width,a.texture.frame.height,a.anchor.x*-a.texture.frame.width,a.anchor.y*-a.texture.frame.height,a.texture.frame.width,a.texture.frame.height));else if(a instanceof c.Strip)this.context.setTransform(a.worldTransform[0],a.worldTransform[3],a.worldTransform[1],a.worldTransform[4],a.worldTransform[2],a.worldTransform[5]),this.renderStrip(a);else if(a instanceof c.TilingSprite)this.context.setTransform(a.worldTransform[0],a.worldTransform[3],a.worldTransform[1],a.worldTransform[4],a.worldTransform[2],a.worldTransform[5]),this.renderTilingSprite(a);else if(a instanceof c.CustomRenderable)a.renderCanvas(this);else if(a instanceof c.Graphics)this.context.setTransform(a.worldTransform[0],a.worldTransform[3],a.worldTransform[1],a.worldTransform[4],a.worldTransform[2],a.worldTransform[5]),c.CanvasGraphics.renderGraphics(a,this.context);else if(a instanceof c.FilterBlock)if(a.open){this.context.save();var d=a.mask.alpha,e=a.mask.worldTransform;this.context.setTransform(e[0],e[3],e[1],e[4],e[2],e[5]),a.mask.worldAlpha=.5,this.context.worldAlpha=0,c.CanvasGraphics.renderGraphicsMask(a.mask,this.context),this.context.clip(),a.mask.worldAlpha=d}else this.context.restore();a=a._iNext}else a=a._iNext;else a=a.last._iNext;while(a!=b)},c.WebGLBatch.prototype.update=function(){for(var a,b,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r=0,s=this.head;s;){if(s.vcount===c.visibleCount){if(b=s.texture.frame.width,d=s.texture.frame.height,e=s.anchor.x,f=s.anchor.y,g=b*(1-e),h=b*-e,i=d*(1-f),j=d*-f,k=8*r,a=s.worldTransform,l=a[0],m=a[3],n=a[1],o=a[4],p=a[2],q=a[5],s.texture.trimmed&&(p+=s.texture.trim.x,q+=s.texture.trim.y),this.verticies[k+0]=l*h+n*j+p,this.verticies[k+1]=o*j+m*h+q,this.verticies[k+2]=l*g+n*j+p,this.verticies[k+3]=o*j+m*g+q,this.verticies[k+4]=l*g+n*i+p,this.verticies[k+5]=o*i+m*g+q,this.verticies[k+6]=l*h+n*i+p,this.verticies[k+7]=o*i+m*h+q,s.updateFrame||s.texture.updateFrame){this.dirtyUVS=!0;var t=s.texture,u=t.frame,v=t.baseTexture.width,w=t.baseTexture.height;this.uvs[k+0]=u.x/v,this.uvs[k+1]=u.y/w,this.uvs[k+2]=(u.x+u.width)/v,this.uvs[k+3]=u.y/w,this.uvs[k+4]=(u.x+u.width)/v,this.uvs[k+5]=(u.y+u.height)/w,this.uvs[k+6]=u.x/v,this.uvs[k+7]=(u.y+u.height)/w,s.updateFrame=!1}if(s.cacheAlpha!=s.worldAlpha){s.cacheAlpha=s.worldAlpha;var x=4*r;this.colors[x]=this.colors[x+1]=this.colors[x+2]=this.colors[x+3]=s.worldAlpha,this.dirtyColors=!0}}else k=8*r,this.verticies[k+0]=0,this.verticies[k+1]=0,this.verticies[k+2]=0,this.verticies[k+3]=0,this.verticies[k+4]=0,this.verticies[k+5]=0,this.verticies[k+6]=0,this.verticies[k+7]=0;r++,s=s.__next}},d});var gameBike={};gameBike.Boot=function(){},gameBike.Boot.prototype={preload:function(){this.load.image("preloaderBarBack","assets/img/LoadingBG.png"),this.load.image("preloaderBar","assets/img/Loading.png")},create:function(){this.game.input.maxPointers=1,this.game.stage.disableVisibilityChange=!0,this.game.device.desktop?this.game.stage.scale.pageAlignHorizontally=!0:(this.game.stage.scaleMode=Phaser.StageScaleMode.SHOW_ALL,this.game.stage.scale.minWidth=480,this.game.stage.scale.minHeight=260,this.game.stage.scale.maxWidth=1024,this.game.stage.scale.maxHeight=768,this.game.stage.scale.forceLandscape=!0,this.game.stage.scale.pageAlignHorizontally=!0,this.game.stage.scale.setScreenSize(!0)),this.game.state.start("Preloader")}},gameBike.Preloader=function(){this.background=null,this.preloadBar=null,this.ready=!1},gameBike.Preloader.prototype={preload:function(){{var a="Loading...",b={font:"60px source_code",fill:"#F0F0F0",align:"center"};this.add.text(this.world.centerX-170,this.world.centerY-50,a,b)}this.game.stage.backgroundColor="#2D4D4D",this.preloadBar=this.add.sprite(this.world.centerX-255,this.world.centerY+50,"preloaderBarBack"),this.preloadBar=this.add.sprite(this.world.centerX-250,this.world.centerY+55,"preloaderBar"),this.load.setPreloadSprite(this.preloadBar),this.load.atlasJSONHash("bike","assets/sprites/bike.png","assets/sprites/bike.json"),this.load.atlasJSONHash("btt_play","assets/sprites/btt.png","assets/sprites/btt.json"),this.load.atlasJSONHash("ball","assets/sprites/ball.png","assets/sprites/ball.json"),this.load.audio("ambient",["assets/audio/Bike2.mp3","assets/audio/Bike2.ogg"])},create:function(){this.preloadBar.cropEnabled=!1},update:function(){this.cache.isSoundDecoded("ambient")&&0==this.ready&&(this.ready=!1,this.game.state.start("MainMenu"))}},gameBike.MainMenu=function(){this.music=null,this.playButton=null,this.audioStatus=!0},gameBike.MainMenu.prototype={create:function(){var a=this.game.input.keyboard.addKey(Phaser.Keyboard.ENTER);a.onDown.add(this.startGame,this);{var b="Bike \n\n | up | down | left | right | m | p |",c={font:"50px source_code",fill:"#F0F0F0",align:"center"};this.add.text(this.world.centerX-520,this.world.centerY-200,b,c),this.game.add.button(this.game.world.centerX-50,this.world.centerY+80,"btt_play",this.startGame,this,1,0,2)}},startGame:function(){this.game.state.start("Game")}},gameBike.Game=function(){this.game,this.add,this.camera,this.cache,this.input,this.load,this.math,this.sound,this.stage,this.time,this.tweens,this.world,this.particles,this.physics,this.rnd,this.gballs,this.bike,this.line,this.pointerOnDown,this.pointerOnUp,this.speed,this.second2,this.second5,this.second7,this.score,this.multiplier,this.playingMusic,this.win,this.dead,this.upKey,this.touchPointer,this.muteKey,this.pauseKey,this.enterKey,this.scoreText,this.multiplier_text,this.alive_text},gameBike.Game.prototype={create:function(){this.game.input.addPointer(),playingMusic=!0,speed=400,score=0,multiplier=1,second2=0,second5=0,second7=0,win=!1,dead=!1,pointerOnDown=0,music=this.game.add.audio("ambient",1,!0),music.play("",0,1,!0),gballs=this.game.add.group();for(var a=0;a<(this.game.world.width-100)/42;a++)for(var b=0;b<(this.game.world.height-100)/42;b++){gballs.create(42*a+42,42*b+42,"ball")}gballs.forEach(this.resetGballs,this,!0,!0),this.create_powerUp(),bike=this.game.add.sprite(this.world.centerX,this.world.centerY,"bike"),bike.anchor.setTo(.5,.5),bike.animations.add("run"),bike.body.collideWorldBounds=!1,bike.body.allowRotation=!0,bike.body.velocity.y=-speed,bike.inWorldThreshold=5e4,bike.scale.setTo(1.5,1.5),line=this.game.add.graphics(0,0),upKey=this.game.input.keyboard.addKey(Phaser.Keyboard.UP),downKey=this.game.input.keyboard.addKey(Phaser.Keyboard.DOWN),leftKey=this.game.input.keyboard.addKey(Phaser.Keyboard.LEFT),rightKey=this.game.input.keyboard.addKey(Phaser.Keyboard.RIGHT),pauseKey=this.game.input.keyboard.addKey(Phaser.Keyboard.P),muteKey=this.game.input.keyboard.addKey(Phaser.Keyboard.M),fullScreenKey=this.game.input.keyboard.addKey(Phaser.Keyboard.F),enterKey=this.game.input.keyboard.addKey(Phaser.Keyboard.ENTER),touchPointer=this.game.input.pointer1,pauseKey.onDown.add(this.managePause,this),muteKey.onDown.add(this.manageSound,this),enterKey.onDown.add(this.manageEnter,this),fullScreenKey.onDown.add(this.manageFullScreen,this),alive_text=this.game.add.text(50,5,"Balls: "+gballs.countLiving(),{font:"20px source_code",fill:"#F0F0F0",align:"center"}),scoreText=this.game.add.text(this.world.centerX-70,5,"Score: "+score,{font:"20px source_code",fill:"#F0F0F0",align:"center"}),multiplier_text=this.game.add.text(this.world.width-100,5,"X"+multiplier,{font:"20px source_code",fill:"#F0F0F0",align:"center"})},update:function(){this.game.physics.overlap(bike,gballs,this.collectBalls,null,this),scoreText.setText("Score: "+score+" - "+Math.floor(this.time.totalElapsedSeconds())),alive_text.setText("Balls: "+gballs.countLiving()),multiplier_text.setText("X"+multiplier),seconds=Math.floor(this.time.totalElapsedSeconds()),second2==seconds||seconds%2!=0||win||dead?second5==seconds||seconds%5!=0||win||dead||(this.create_powerUp(),second5=seconds,console.log("5 segundos")):(this.reviveBall(),second2=seconds,console.log("2 segundos")),win||dead||(speed=400+50*multiplier),bike.inWorld||(console.log("In world: "+bike.inWorld),win=!1,dead=!0,this.gameOver()),this.game.input.keyboard.isDown(Phaser.Keyboard.LEFT)?(bike.body.velocity.y=0,bike.body.velocity.x=-speed,bike.body.rotation=-90,bike.body.setSize(50,20,0,0),bike.animations.play("run",15,!0)):this.game.input.keyboard.isDown(Phaser.Keyboard.RIGHT)?(bike.body.velocity.y=0,bike.body.velocity.x=speed,bike.body.rotation=90,bike.body.setSize(50,20,0,0),bike.animations.play("run",15,!0)):this.game.input.keyboard.isDown(Phaser.Keyboard.UP)?(bike.body.velocity.y=-speed,bike.body.velocity.x=0,bike.body.rotation=-180,bike.body.setSize(20,50,0,0),bike.animations.play("run",15,!0)):this.game.input.keyboard.isDown(Phaser.Keyboard.DOWN)&&(bike.body.velocity.y=speed,bike.body.velocity.x=0,bike.body.rotation=180,bike.body.setSize(20,50,0,0),bike.animations.play("run",15,!0)),touchPointer.isDown&&(pointerOnDown=touchPointer.positionDown,bike.x>touchPointer.x&&Math.abs(touchPointer.x-bike.x)>Math.abs(touchPointer.y-bike.y)?(console.log("left"),bike.body.velocity.y=0,bike.body.velocity.x=-speed,bike.body.rotation=-90,bike.body.setSize(50,20,0,0),bike.animations.play("run",15,!0)):bike.x<touchPointer.x&&Math.abs(touchPointer.x-bike.x)>Math.abs(touchPointer.y-bike.y)?(console.log("right"),bike.body.velocity.y=0,bike.body.velocity.x=speed,bike.body.rotation=90,bike.body.setSize(50,20,0,0),bike.animations.play("run",15,!0)):bike.y>touchPointer.y&&Math.abs(touchPointer.x-bike.x)<Math.abs(touchPointer.y-bike.y)?(console.log("up"),bike.body.velocity.y=-speed,bike.body.velocity.x=0,bike.body.rotation=-180,bike.body.setSize(20,50,0,0),bike.animations.play("run",15,!0)):bike.y<touchPointer.y&&Math.abs(touchPointer.x-bike.x)<Math.abs(touchPointer.y-bike.y)&&(console.log("down"),bike.body.velocity.y=speed,bike.body.velocity.x=0,bike.body.rotation=180,bike.body.setSize(20,50,0,0),bike.animations.play("run",15,!0)))},render:function(){},quitGame:function(){this.game.state.start("MainMenu")},resetGballs:function(a,b){b&&(a.frameName="ball01.ase",a.animations.add("blue_ball",Phaser.Animation.generateFrameNames("ball",0,0,".ase",2),60,!0),a.animations.add("red_ball",Phaser.Animation.generateFrameNames("ball",8,15,".ase",2),60,!0)),a.animations.play("blue_ball",1,!0),a.name="normal"},collectBalls:function(a,b){"powerUp"==b.name&&multiplier++,b.kill(),score+=multiplier,0==gballs.countLiving()&&(win=!0,this.gameOver())},reviveBall:function(){var a;if(gballs.countDead()>0){if(1==gballs.countDead())a=gballs.getFirstDead();else do a=gballs.getRandom();while(a.alive);a.revive()}},create_powerUp:function(){var a;if(gballs.countLiving()>0){if(1==gballs.countLiving())a=gballs.getFirstAlive();else do a=gballs.getRandom();while(!a.alive);gballs.forEach(this.resetGballs,this,!0,!1),a.animations.play("red_ball",15,!0),a.name="powerUp"}},gameOver:function(){if(speed=0,bike.body.velocity.x=speed,bike.body.velocity.y=0,win){var a=this.game.add.text(this.world.centerX,this.world.centerY,"Congratulations you win! \n Score: "+score,{font:"60px source_code",fill:"#F0F0F0",align:"center"});a.anchor.setTo(.5,.5)}else if(dead){var a=this.game.add.text(this.world.centerX,this.world.centerY,"You loose :c \n Score: "+score,{font:"60px source_code",fill:"#F0F0F0",align:"center"});console.log("dead"),a.anchor.setTo(.5,.5),dead=!1,this.managePause()}},reStart:function(){music.pause(),music=0,this.game.state.start("Game")},managePause:function(){this.game.paused=this.game.paused?!1:!0},manageSound:function(){playingMusic?music.pause():music.resume(),playingMusic=!playingMusic},manageEnter:function(){(this.game.paused||dead)&&(this.game.paused=!1,this.reStart())},manageFullScreen:function(){this.game.stage.scale.startFullScreen()},clearGraphics:function(){}};
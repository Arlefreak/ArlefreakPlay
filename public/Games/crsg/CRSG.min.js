...
this.shapeChanged()},addShape:function(a,b,c,d){return"undefined"==typeof b&&(b=0),"undefined"==typeof c&&(c=0),"undefined"==typeof d&&(d=0),this.data.addShape(a,[this.world.pxmi(b),this.world.pxmi(c)],d),this.shapeChanged(),a},addCircle:function(a,b,c,d){var e=new p2.Circle(this.world.pxm(a));return this.addShape(e,b,c,d)},addRectangle:function(a,b,c,d,e){var f=new p2.Rectangle(this.world.pxm(a),this.world.pxm(b));return this.addShape(f,c,d,e)},addPlane:function(a,b,c){var d=new p2.Plane;return this.addShape(d,a,b,c)},addParticle:function(a,b,c){var d=new p2.Particle;return this.addShape(d,a,b,c)},addLine:function(a,b,c,d){var e=new p2.Line(this.world.pxm(a));return this.addShape(e,b,c,d)},addCapsule:function(a,b,c,d,e){var f=new p2.Capsule(this.world.pxm(a),this.world.pxm(b));return this.addShape(f,c,d,e)},addPolygon:function(a,b){a=a||{},Array.isArray(b)||(b=Array.prototype.slice.call(arguments,1));var c=[];if(1===b.length&&Array.isArray(b[0]))c=b[0].slice(0);else if(Array.isArray(b[0]))c=b.slice();else if("number"==typeof b[0])for(var d=0,e=b.length;e>d;d+=2)c.push([b[d],b[d+1]]);var f=c.length-1;c[f][0]===c[0][0]&&c[f][1]===c[0][1]&&c.pop();for(var g=0;g<c.length;g++)c[g][0]=this.world.pxmi(c[g][0]),c[g][1]=this.world.pxmi(c[g][1]);var h=this.data.fromPolygon(c,a);return this.shapeChanged(),h},removeShape:function(a){var b=this.data.removeShape(a);return this.shapeChanged(),b},setCircle:function(a,b,c,d){return this.clearShapes(),this.addCircle(a,b,c,d)},setRectangle:function(a,b,c,d,e){return"undefined"==typeof a&&(a=16),"undefined"==typeof b&&(b=16),this.clearShapes(),this.addRectangle(a,b,c,d,e)},setRectangleFromSprite:function(a){return"undefined"==typeof a&&(a=this.sprite),this.clearShapes(),this.addRectangle(a.width,a.height,0,0,a.rotation)},setMaterial:function(a,b){if("undefined"==typeof b)for(var c=this.data.shapes.length-1;c>=0;c--)this.data.shapes[c].material=a;else b.material=a},shapeChanged:function(){this.debugBody&&this.debugBody.draw()},addPhaserPolygon:function(a,b){for(var c=this.game.cache.getPhysicsData(a,b),d=[],e=0;e<c.length;e++){var f=c[e],g=this.addFixture(f);d[f.filter.group]=d[f.filter.group]||[],d[f.filter.group]=d[f.filter.group].concat(g),f.fixtureKey&&(d[f.fixtureKey]=g)}return this.data.aabbNeedsUpdate=!0,this.shapeChanged(),d},addFixture:function(a){var b=[];if(a.circle){var c=new p2.Circle(this.world.pxm(a.circle.radius));c.collisionGroup=a.filter.categoryBits,c.collisionMask=a.filter.maskBits,c.sensor=a.isSensor;var d=p2.vec2.create();d[0]=this.world.pxmi(a.circle.position[0]-this.sprite.width/2),d[1]=this.world.pxmi(a.circle.position[1]-this.sprite.height/2),this.data.addShape(c,d),b.push(c)}else for(var e=a.polygons,f=p2.vec2.create(),g=0;g<e.length;g++){for(var h=e[g],i=[],j=0;j<h.length;j+=2)i.push([this.world.pxmi(h[j]),this.world.pxmi(h[j+1])]);for(var c=new p2.Convex(i),k=0;k!==c.vertices.length;k++){var l=c.vertices[k];p2.vec2.sub(l,l,c.centerOfMass)}p2.vec2.scale(f,c.centerOfMass,1),f[0]-=this.world.pxmi(this.sprite.width/2),f[1]-=this.world.pxmi(this.sprite.height/2),c.updateTriangles(),c.updateCenterOfMass(),c.updateBoundingRadius(),c.collisionGroup=a.filter.categoryBits,c.collisionMask=a.filter.maskBits,c.sensor=a.isSensor,this.data.addShape(c,f),b.push(c)}return b},loadPolygon:function(a,b){for(var c=this.game.cache.getPhysicsData(a,b),d=p2.vec2.create(),e=0;e<c.length;e++){for(var f=[],g=0;g<c[e].shape.length;g+=2)f.push([this.world.pxmi(c[e].shape[g]),this.world.pxmi(c[e].shape[g+1])]);for(var h=new p2.Convex(f),i=0;i!==h.vertices.length;i++){var j=h.vertices[i];p2.vec2.sub(j,j,h.centerOfMass)}p2.vec2.scale(d,h.centerOfMass,1),d[0]-=this.world.pxmi(this.sprite.width/2),d[1]-=this.world.pxmi(this.sprite.height/2),h.updateTriangles(),h.updateCenterOfMass(),h.updateBoundingRadius(),this.data.addShape(h,d)}return this.data.aabbNeedsUpdate=!0,this.shapeChanged(),!0}},Phaser.Physics.P2.Body.prototype.constructor=Phaser.Physics.P2.Body,Phaser.Physics.P2.Body.DYNAMIC=1,Phaser.Physics.P2.Body.STATIC=2,Phaser.Physics.P2.Body.KINEMATIC=4,Object.defineProperty(Phaser.Physics.P2.Body.prototype,"static",{get:function(){return this.data.type===Phaser.Physics.P2.Body.STATIC},set:function(a){a&&this.data.type!==Phaser.Physics.P2.Body.STATIC?(this.data.type=Phaser.Physics.P2.Body.STATIC,this.mass=0):a||this.data.type!==Phaser.Physics.P2.Body.STATIC||(this.data.type=Phaser.Physics.P2.Body.DYNAMIC,0===this.mass&&(this.mass=1))}}),Object.defineProperty(Phaser.Physics.P2.Body.prototype,"dynamic",{get:function(){return this.data.type===Phaser.Physics.P2.Body.DYNAMIC},set:function(a){a&&this.data.type!==Phaser.Physics.P2.Body.DYNAMIC?(this.data.type=Phaser.Physics.P2.Body.DYNAMIC,0===this.mass&&(this.mass=1)):a||this.data.type!==Phaser.Physics.P2.Body.DYNAMIC||(this.data.type=Phaser.Physics.P2.Body.STATIC,this.mass=0)}}),Object.defineProperty(Phaser.Physics.P2.Body.prototype,"kinematic",{get:function(){return this.data.type===Phaser.Physics.P2.Body.KINEMATIC},set:function(a){a&&this.data.type!==Phaser.Physics.P2.Body.KINEMATIC?(this.data.type=Phaser.Physics.P2.Body.KINEMATIC,this.mass=4):a||this.data.type!==Phaser.Physics.P2.Body.KINEMATIC||(this.data.type=Phaser.Physics.P2.Body.STATIC,this.mass=0)}}),Object.defineProperty(Phaser.Physics.P2.Body.prototype,"allowSleep",{get:function(){return this.data.allowSleep},set:function(a){a!==this.data.allowSleep&&(this.data.allowSleep=a)}}),Object.defineProperty(Phaser.Physics.P2.Body.prototype,"angle",{get:function(){return Phaser.Math.wrapAngle(Phaser.Math.radToDeg(this.data.angle))},set:function(a){this.data.angle=Phaser.Math.degToRad(Phaser.Math.wrapAngle(a))}}),Object.defineProperty(Phaser.Physics.P2.Body.prototype,"angularDamping",{get:function(){return this.data.angularDamping},set:function(a){this.data.angularDamping=a}}),Object.defineProperty(Phaser.Physics.P2.Body.prototype,"angularForce",{get:function(){return this.data.angularForce},set:function(a){this.data.angularForce=a}}),Object.defineProperty(Phaser.Physics.P2.Body.prototype,"angularVelocity",{get:function(){return this.data.angularVelocity},set:function(a){this.data.angularVelocity=a}}),Object.defineProperty(Phaser.Physics.P2.Body.prototype,"damping",{get:function(){return this.data.damping},set:function(a){this.data.damping=a}}),Object.defineProperty(Phaser.Physics.P2.Body.prototype,"fixedRotation",{get:function(){return this.data.fixedRotation},set:function(a){a!==this.data.fixedRotation&&(this.data.fixedRotation=a)}}),Object.defineProperty(Phaser.Physics.P2.Body.prototype,"inertia",{get:function(){return this.data.inertia},set:function(a){this.data.inertia=a}}),Object.defineProperty(Phaser.Physics.P2.Body.prototype,"mass",{get:function(){return this.data.mass},set:function(a){a!==this.data.mass&&(this.data.mass=a,this.data.updateMassProperties())}}),Object.defineProperty(Phaser.Physics.P2.Body.prototype,"motionState",{get:function(){return this.data.type},set:function(a){a!==this.data.type&&(this.data.type=a)}}),Object.defineProperty(Phaser.Physics.P2.Body.prototype,"rotation",{get:function(){return this.data.angle},set:function(a){this.data.angle=a}}),Object.defineProperty(Phaser.Physics.P2.Body.prototype,"sleepSpeedLimit",{get:function(){return this.data.sleepSpeedLimit},set:function(a){this.data.sleepSpeedLimit=a}}),Object.defineProperty(Phaser.Physics.P2.Body.prototype,"x",{get:function(){return this.world.mpxi(this.data.position[0])},set:function(a){this.data.position[0]=this.world.pxmi(a)}}),Object.defineProperty(Phaser.Physics.P2.Body.prototype,"y",{get:function(){return this.world.mpxi(this.data.position[1])},set:function(a){this.data.position[1]=this.world.pxmi(a)}}),Object.defineProperty(Phaser.Physics.P2.Body.prototype,"id",{get:function(){return this.data.id}}),Object.defineProperty(Phaser.Physics.P2.Body.prototype,"debug",{get:function(){return null!==this.debugBody},set:function(a){a&&!this.debugBody?this.debugBody=new Phaser.Physics.P2.BodyDebug(this.game,this.data):!a&&this.debugBody&&(this.debugBody.destroy(),this.debugBody=null)}}),Object.defineProperty(Phaser.Physics.P2.Body.prototype,"collideWorldBounds",{get:function(){return this._collideWorldBounds},set:function(a){a&&!this._collideWorldBounds?(this._collideWorldBounds=!0,this.updateCollisionMask()):!a&&this._collideWorldBounds&&(this._collideWorldBounds=!1,this.updateCollisionMask())}}),Phaser.Physics.P2.BodyDebug=function(a,b,c){Phaser.Group.call(this,a);var d={pixelsPerLengthUnit:20,debugPolygons:!1,lineWidth:1,alpha:.5};this.settings=Phaser.Utils.extend(d,c),this.ppu=this.settings.pixelsPerLengthUnit,this.ppu=-1*this.ppu,this.body=b,this.canvas=new Phaser.Graphics(a),this.canvas.alpha=this.settings.alpha,this.add(this.canvas),this.draw()},Phaser.Physics.P2.BodyDebug.prototype=Object.create(Phaser.Group.prototype),Phaser.Physics.P2.BodyDebug.prototype.constructor=Phaser.Physics.P2.BodyDebug,Phaser.Utils.extend(Phaser.Physics.P2.BodyDebug.prototype,{update:function(){this.updateSpriteTransform()},updateSpriteTransform:function(){return this.position.x=this.body.position[0]*this.ppu,this.position.y=this.body.position[1]*this.ppu,this.rotation=this.body.angle},draw:function(){var a,b,c,d,e,f,g,h,i,j,k,l,m,n,o;if(h=this.body,j=this.canvas,j.clear(),c=parseInt(this.randomPastelHex(),16),f=16711680,g=this.lineWidth,h instanceof p2.Body&&h.shapes.length){var p=h.shapes.length;for(d=0;d!==p;){if(b=h.shapes[d],i=h.shapeOffsets[d],a=h.shapeAngles[d],i=i||0,a=a||0,b instanceof p2.Circle)this.drawCircle(j,i[0]*this.ppu,i[1]*this.ppu,a,b.radius*this.ppu,c,g);else if(b instanceof p2.Convex){for(l=[],m=p2.vec2.create(),e=n=0,o=b.vertices.length;o>=0?o>n:n>o;e=o>=0?++n:--n)k=b.vertices[e],p2.vec2.rotate(m,k,a),l.push([(m[0]+i[0])*this.ppu,-(m[1]+i[1])*this.ppu]);this.drawConvex(j,l,b.triangles,f,c,g,this.settings.debugPolygons,[i[0]*this.ppu,-i[1]*this.ppu])}else b instanceof p2.Plane?this.drawPlane(j,i[0]*this.ppu,-i[1]*this.ppu,c,f,5*g,10*g,10*g,100*this.ppu,a):b instanceof p2.Line?this.drawLine(j,b.length*this.ppu,f,g):b instanceof p2.Rectangle&&this.drawRectangle(j,i[0]*this.ppu,-i[1]*this.ppu,a,b.width*this.ppu,b.height*this.ppu,f,c,g);d++}}},drawRectangle:function(a,b,c,d,e,f,g,h,i){"undefined"==typeof i&&(i=1),"undefined"==typeof g&&(g=0),a.lineStyle(i,g,1),a.beginFill(h),a.drawRect(b-e/2,c-f/2,e,f)},drawCircle:function(a,b,c,d,e,f,g){"undefined"==typeof g&&(g=1),"undefined"==typeof f&&(f=16777215),a.lineStyle(g,0,1),a.beginFill(f,1),a.drawCircle(b,c,-e),a.endFill(),a.moveTo(b,c),a.lineTo(b+e*Math.cos(-d),c+e*Math.sin(-d))},drawLine:function(a,b,c,d){"undefined"==typeof d&&(d=1),"undefined"==typeof c&&(c=0),a.lineStyle(5*d,c,1),a.moveTo(-b/2,0),a.lineTo(b/2,0)},drawConvex:function(a,b,c,d,e,f,g,h){var i,j,k,l,m,n,o,p,q,r,s;if("undefined"==typeof f&&(f=1),"undefined"==typeof d&&(d=0),g){for(i=[16711680,65280,255],j=0;j!==b.length+1;)l=b[j%b.length],m=b[(j+1)%b.length],o=l[0],r=l[1],p=m[0],s=m[1],a.lineStyle(f,i[j%i.length],1),a.moveTo(o,-r),a.lineTo(p,-s),a.drawCircle(o,-r,2*f),j++;return a.lineStyle(f,0,1),a.drawCircle(h[0],h[1],2*f)}for(a.lineStyle(f,d,1),a.beginFill(e),j=0;j!==b.length;)k=b[j],n=k[0],q=k[1],0===j?a.moveTo(n,-q):a.lineTo(n,-q),j++;return a.endFill(),b.length>2?(a.moveTo(b[b.length-1][0],-b[b.length-1][1]),a.lineTo(b[0][0],-b[0][1])):void 0},drawPath:function(a,b,c,d,e){var f,g,h,i,j,k,l,m,n,o,p,q,r;for("undefined"==typeof e&&(e=1),"undefined"==typeof c&&(c=0),a.lineStyle(e,c,1),"number"==typeof d&&a.beginFill(d),h=null,i=null,g=0;g<b.length;)p=b[g],q=p[0],r=p[1],(q!==h||r!==i)&&(0===g?a.moveTo(q,r):(j=h,k=i,l=q,m=r,n=b[(g+1)%b.length][0],o=b[(g+1)%b.length][1],f=(l-j)*(o-k)-(n-j)*(m-k),0!==f&&a.lineTo(q,r)),h=q,i=r),g++;"number"==typeof d&&a.endFill(),b.length>2&&"number"==typeof d&&(a.moveTo(b[b.length-1][0],b[b.length-1][1]),a.lineTo(b[0][0],b[0][1]))},drawPlane:function(a,b,c,d,e,f,g,h,i,j){var k,l,m;"undefined"==typeof f&&(f=1),"undefined"==typeof d&&(d=16777215),a.lineStyle(f,e,11),a.beginFill(d),k=i,a.moveTo(b,-c),l=b+Math.cos(j)*this.game.width,m=c+Math.sin(j)*this.game.height,a.lineTo(l,-m),a.moveTo(b,-c),l=b+Math.cos(j)*-this.game.width,m=c+Math.sin(j)*-this.game.height,a.lineTo(l,-m)},randomPastelHex:function(){var a,b,c,d;return c=[255,255,255],d=Math.floor(256*Math.random()),b=Math.floor(256*Math.random()),a=Math.floor(256*Math.random()),d=Math.floor((d+3*c[0])/4),b=Math.floor((b+3*c[1])/4),a=Math.floor((a+3*c[2])/4),this.rgbToHex(d,b,a)},rgbToHex:function(a,b,c){return this.componentToHex(a)+this.componentToHex(b)+this.componentToHex(c)},componentToHex:function(a){var b;return b=a.toString(16),2===b.len?b:b+"0"}}),Phaser.Physics.P2.Spring=function(a,b,c,d,e,f,g,h,i,j){this.game=a.game,this.world=a,"undefined"==typeof d&&(d=1),"undefined"==typeof e&&(e=100),"undefined"==typeof f&&(f=1),d=a.pxm(d);var k={restLength:d,stiffness:e,damping:f};"undefined"!=typeof g&&null!==g&&(k.worldAnchorA=[a.pxm(g[0]),a.pxm(g[1])]),"undefined"!=typeof h&&null!==h&&(k.worldAnchorB=[a.pxm(h[0]),a.pxm(h[1])]),"undefined"!=typeof i&&null!==i&&(k.localAnchorA=[a.pxm(i[0]),a.pxm(i[1])]),"undefined"!=typeof j&&null!==j&&(k.localAnchorB=[a.pxm(j[0]),a.pxm(j[1])]),this.data=new p2.LinearSpring(b,c,k),this.data.parent=this},Phaser.Physics.P2.Spring.prototype.constructor=Phaser.Physics.P2.Spring,Phaser.Physics.P2.RotationalSpring=function(a,b,c,d,e,f){this.game=a.game,this.world=a,"undefined"==typeof d&&(d=null),"undefined"==typeof e&&(e=100),"undefined"==typeof f&&(f=1),d&&(d=a.pxm(d));var g={restAngle:d,stiffness:e,damping:f};this.data=new p2.RotationalSpring(b,c,g),this.data.parent=this},Phaser.Physics.P2.Spring.prototype.constructor=Phaser.Physics.P2.Spring,Phaser.Physics.P2.Material=function(a){this.name=a,p2.Material.call(this)},Phaser.Physics.P2.Material.prototype=Object.create(p2.Material.prototype),Phaser.Physics.P2.Material.prototype.constructor=Phaser.Physics.P2.Material,Phaser.Physics.P2.ContactMaterial=function(a,b,c){p2.ContactMaterial.call(this,a,b,c)},Phaser.Physics.P2.ContactMaterial.prototype=Object.create(p2.ContactMaterial.prototype),Phaser.Physics.P2.ContactMaterial.prototype.constructor=Phaser.Physics.P2.ContactMaterial,Phaser.Physics.P2.CollisionGroup=function(a){this.mask=a},Phaser.Physics.P2.DistanceConstraint=function(a,b,c,d,e,f,g){"undefined"==typeof d&&(d=100),"undefined"==typeof e&&(e=[0,0]),"undefined"==typeof f&&(f=[0,0]),"undefined"==typeof g&&(g=Number.MAX_VALUE),this.game=a.game,this.world=a,d=a.pxm(d),e=[a.pxmi(e[0]),a.pxmi(e[1])],f=[a.pxmi(f[0]),a.pxmi(f[1])];var h={distance:d,localAnchorA:e,localAnchorB:f,maxForce:g};p2.DistanceConstraint.call(this,b,c,h)},Phaser.Physics.P2.DistanceConstraint.prototype=Object.create(p2.DistanceConstraint.prototype),Phaser.Physics.P2.DistanceConstraint.prototype.constructor=Phaser.Physics.P2.DistanceConstraint,Phaser.Physics.P2.GearConstraint=function(a,b,c,d,e){"undefined"==typeof d&&(d=0),"undefined"==typeof e&&(e=1),this.game=a.game,this.world=a;var f={angle:d,ratio:e};p2.GearConstraint.call(this,b,c,f)},Phaser.Physics.P2.GearConstraint.prototype=Object.create(p2.GearConstraint.prototype),Phaser.Physics.P2.GearConstraint.prototype.constructor=Phaser.Physics.P2.GearConstraint,Phaser.Physics.P2.LockConstraint=function(a,b,c,d,e,f){"undefined"==typeof d&&(d=[0,0]),"undefined"==typeof e&&(e=0),"undefined"==typeof f&&(f=Number.MAX_VALUE),this.game=a.game,this.world=a,d=[a.pxm(d[0]),a.pxm(d[1])];var g={localOffsetB:d,localAngleB:e,maxForce:f};p2.LockConstraint.call(this,b,c,g)},Phaser.Physics.P2.LockConstraint.prototype=Object.create(p2.LockConstraint.prototype),Phaser.Physics.P2.LockConstraint.prototype.constructor=Phaser.Physics.P2.LockConstraint,Phaser.Physics.P2.PrismaticConstraint=function(a,b,c,d,e,f,g,h){"undefined"==typeof d&&(d=!0),"undefined"==typeof e&&(e=[0,0]),"undefined"==typeof f&&(f=[0,0]),"undefined"==typeof g&&(g=[0,0]),"undefined"==typeof h&&(h=Number.MAX_VALUE),this.game=a.game,this.world=a,e=[a.pxmi(e[0]),a.pxmi(e[1])],f=[a.pxmi(f[0]),a.pxmi(f[1])];var i={localAnchorA:e,localAnchorB:f,localAxisA:g,maxForce:h,disableRotationalLock:!d};p2.PrismaticConstraint.call(this,b,c,i)},Phaser.Physics.P2.PrismaticConstraint.prototype=Object.create(p2.PrismaticConstraint.prototype),Phaser.Physics.P2.PrismaticConstraint.prototype.constructor=Phaser.Physics.P2.PrismaticConstraint,Phaser.Physics.P2.RevoluteConstraint=function(a,b,c,d,e,f,g){"undefined"==typeof f&&(f=Number.MAX_VALUE),"undefined"==typeof g&&(g=null),this.game=a.game,this.world=a,c=[a.pxmi(c[0]),a.pxmi(c[1])],e=[a.pxmi(e[0]),a.pxmi(e[1])],g&&(g=[a.pxmi(g[0]),a.pxmi(g[1])]);var h={worldPivot:g,localPivotA:c,localPivotB:e,maxForce:f};p2.RevoluteConstraint.call(this,b,d,h)},Phaser.Physics.P2.RevoluteConstraint.prototype=Object.create(p2.RevoluteConstraint.prototype),Phaser.Physics.P2.RevoluteConstraint.prototype.constructor=Phaser.Physics.P2.RevoluteConstraint,Array.prototype.equals=function(a){if(!a)return!1;if(this.length!=a.length)return!1;for(var b=0,c=this.length;c>b;b++)if(this[b]instanceof Array&&a[b]instanceof Array){if(!this[b].equals(a[b]))return!1}else if(this[b]!=a[b])return!1;return!0};var randomBoolean=function(){return Math.random()<.5},indexOf=function(a){return indexOf="function"==typeof Array.prototype.indexOf?Array.prototype.indexOf:function(a){var b=-1,c=-1;for(b=0;b<this.length;b++)if(this[b]===a){c=b;break}return c},indexOf.call(this,a)};!function(){var a=this,b=a._,c={},d=Array.prototype,e=Object.prototype,f=Function.prototype,g=d.push,h=d.slice,i=d.concat,j=e.toString,k=e.hasOwnProperty,l=d.forEach,m=d.map,n=d.reduce,o=d.reduceRight,p=d.filter,q=d.every,r=d.some,s=d.indexOf,t=d.lastIndexOf,u=Array.isArray,v=Object.keys,w=f.bind,x=function(a){return a instanceof x?a:this instanceof x?void(this._wrapped=a):new x(a)};"undefined"!=typeof exports?("undefined"!=typeof module&&module.exports&&(exports=module.exports=x),exports._=x):a._=x,x.VERSION="1.5.0";var y=x.each=x.forEach=function(a,b,d){if(null!=a)if(l&&a.forEach===l)a.forEach(b,d);else if(a.length===+a.length){for(var e=0,f=a.length;f>e;e++)if(b.call(d,a[e],e,a)===c)return}else for(var g in a)if(x.has(a,g)&&b.call(d,a[g],g,a)===c)return};x.map=x.collect=function(a,b,c){var d=[];return null==a?d:m&&a.map===m?a.map(b,c):(y(a,function(a,e,f){d.push(b.call(c,a,e,f))}),d)};var z="Reduce of empty array with no initial value";x.reduce=x.foldl=x.inject=function(a,b,c,d){var e=arguments.length>2;if(null==a&&(a=[]),n&&a.reduce===n)return d&&(b=x.bind(b,d)),e?a.reduce(b,c):a.reduce(b);if(y(a,function(a,f,g){e?c=b.call(d,c,a,f,g):(c=a,e=!0)}),!e)throw new TypeError(z);return c},x.reduceRight=x.foldr=function(a,b,c,d){var e=arguments.length>2;if(null==a&&(a=[]),o&&a.reduceRight===o)return d&&(b=x.bind(b,d)),e?a.reduceRight(b,c):a.reduceRight(b);var f=a.length;if(f!==+f){var g=x.keys(a);f=g.length}if(y(a,function(h,i,j){i=g?g[--f]:--f,e?c=b.call(d,c,a[i],i,j):(c=a[i],e=!0)}),!e)throw new TypeError(z);return c},x.find=x.detect=function(a,b,c){var d;return A(a,function(a,e,f){return b.call(c,a,e,f)?(d=a,!0):void 0}),d},x.filter=x.select=function(a,b,c){var d=[];return null==a?d:p&&a.filter===p?a.filter(b,c):(y(a,function(a,e,f){b.call(c,a,e,f)&&d.push(a)}),d)},x.reject=function(a,b,c){return x.filter(a,function(a,d,e){return!b.call(c,a,d,e)},c)},x.every=x.all=function(a,b,d){b||(b=x.identity);var e=!0;return null==a?e:q&&a.every===q?a.every(b,d):(y(a,function(a,f,g){return(e=e&&b.call(d,a,f,g))?void 0:c}),!!e)};var A=x.some=x.any=function(a,b,d){b||(b=x.identity);var e=!1;return null==a?e:r&&a.some===r?a.some(b,d):(y(a,function(a,f,g){return e||(e=b.call(d,a,f,g))?c:void 0}),!!e)};x.contains=x.include=function(a,b){return null==a?!1:s&&a.indexOf===s?-1!=a.indexOf(b):A(a,function(a){return a===b})},x.invoke=function(a,b){var c=h.call(arguments,2),d=x.isFunction(b);return x.map(a,function(a){return(d?b:a[b]).apply(a,c)})},x.pluck=function(a,b){return x.map(a,function(a){return a[b]})},x.where=function(a,b,c){return x.isEmpty(b)?c?void 0:[]:x[c?"find":"filter"](a,function(a){for(var c in b)if(b[c]!==a[c])return!1;return!0})},x.findWhere=function(a,b){return x.where(a,b,!0)},x.max=function(a,b,c){if(!b&&x.isArray(a)&&a[0]===+a[0]&&a.length<65535)return Math.max.apply(Math,a);if(!b&&x.isEmpty(a))return-1/0;var d={computed:-1/0,value:-1/0};return y(a,function(a,e,f){var g=b?b.call(c,a,e,f):a;g>d.computed&&(d={value:a,computed:g})}),d.value},x.min=function(a,b,c){if(!b&&x.isArray(a)&&a[0]===+a[0]&&a.length<65535)return Math.min.apply(Math,a);if(!b&&x.isEmpty(a))return 1/0;var d={computed:1/0,value:1/0};return y(a,function(a,e,f){var g=b?b.call(c,a,e,f):a;g<d.computed&&(d={value:a,computed:g})}),d.value},x.shuffle=function(a){var b,c=0,d=[];return y(a,function(a){b=x.random(c++),d[c-1]=d[b],d[b]=a}),d};var B=function(a){return x.isFunction(a)?a:function(b){return b[a]}};x.sortBy=function(a,b,c){var d=B(b);return x.pluck(x.map(a,function(a,b,e){return{value:a,index:b,criteria:d.call(c,a,b,e)}}).sort(function(a,b){var c=a.criteria,d=b.criteria;if(c!==d){if(c>d||void 0===c)return 1;if(d>c||void 0===d)return-1}return a.index<b.index?-1:1}),"value")};var C=function(a,b,c,d){var e={},f=B(null==b?x.identity:b);return y(a,function(b,g){var h=f.call(c,b,g,a);d(e,h,b)}),e};x.groupBy=function(a,b,c){return C(a,b,c,function(a,b,c){(x.has(a,b)?a[b]:a[b]=[]).push(c)})},x.countBy=function(a,b,c){return C(a,b,c,function(a,b){x.has(a,b)||(a[b]=0),a[b]++})},x.sortedIndex=function(a,b,c,d){c=null==c?x.identity:B(c);for(var e=c.call(d,b),f=0,g=a.length;g>f;){var h=f+g>>>1;c.call(d,a[h])<e?f=h+1:g=h}return f},x.toArray=function(a){return a?x.isArray(a)?h.call(a):a.length===+a.length?x.map(a,x.identity):x.values(a):[]},x.size=function(a){return null==a?0:a.length===+a.length?a.length:x.keys(a).length},x.first=x.head=x.take=function(a,b,c){return null==a?void 0:null==b||c?a[0]:h.call(a,0,b)},x.initial=function(a,b,c){return h.call(a,0,a.length-(null==b||c?1:b))},x.last=function(a,b,c){return null==a?void 0:null==b||c?a[a.length-1]:h.call(a,Math.max(a.length-b,0))},x.rest=x.tail=x.drop=function(a,b,c){return h.call(a,null==b||c?1:b)},x.compact=function(a){return x.filter(a,x.identity)};var D=function(a,b,c){return b&&x.every(a,x.isArray)?i.apply(c,a):(y(a,function(a){x.isArray(a)||x.isArguments(a)?b?g.apply(c,a):D(a,b,c):c.push(a)}),c)};x.flatten=function(a,b){return D(a,b,[])},x.without=function(a){return x.difference(a,h.call(arguments,1))},x.uniq=x.unique=function(a,b,c,d){x.isFunction(b)&&(d=c,c=b,b=!1);var e=c?x.map(a,c,d):a,f=[],g=[];return y(e,function(c,d){(b?d&&g[g.length-1]===c:x.contains(g,c))||(g.push(c),f.push(a[d]))}),f},x.union=function(){return x.uniq(x.flatten(arguments,!0))},x.intersection=function(a){var b=h.call(arguments,1);return x.filter(x.uniq(a),function(a){return x.every(b,function(b){return x.indexOf(b,a)>=0})})},x.difference=function(a){var b=i.apply(d,h.call(arguments,1));return x.filter(a,function(a){return!x.contains(b,a)})},x.zip=function(){return x.unzip.apply(x,h.call(arguments))},x.unzip=function(){for(var a=x.max(x.pluck(arguments,"length").concat(0)),b=new Array(a),c=0;a>c;c++)b[c]=x.pluck(arguments,""+c);return b},x.object=function(a,b){if(null==a)return{};for(var c={},d=0,e=a.length;e>d;d++)b?c[a[d]]=b[d]:c[a[d][0]]=a[d][1];return c},x.indexOf=function(a,b,c){if(null==a)return-1;var d=0,e=a.length;if(c){if("number"!=typeof c)return d=x.sortedIndex(a,b),a[d]===b?d:-1;d=0>c?Math.max(0,e+c):c}if(s&&a.indexOf===s)return a.indexOf(b,c);for(;e>d;d++)if(a[d]===b)return d;return-1},x.lastIndexOf=function(a,b,c){if(null==a)return-1;var d=null!=c;if(t&&a.lastIndexOf===t)return d?a.lastIndexOf(b,c):a.lastIndexOf(b);for(var e=d?c:a.length;e--;)if(a[e]===b)return e;return-1},x.range=function(a,b,c){arguments.length<=1&&(b=a||0,a=0),c=arguments[2]||1;for(var d=Math.max(Math.ceil((b-a)/c),0),e=0,f=new Array(d);d>e;)f[e++]=a,a+=c;return f};var E=function(){};x.bind=function(a,b){var c,d;if(w&&a.bind===w)return w.apply(a,h.call(arguments,1));if(!x.isFunction(a))throw new TypeError;return c=h.call(arguments,2),d=function(){if(!(this instanceof d))return a.apply(b,c.concat(h.call(arguments)));E.prototype=a.prototype;var e=new E;E.prototype=null;var f=a.apply(e,c.concat(h.call(arguments)));return Object(f)===f?f:e}},x.partial=function(a){var b=h.call(arguments,1);return function(){return a.apply(this,b.concat(h.call(arguments)))}},x.bindAll=function(a){var b=h.call(arguments,1);if(0===b.length)throw new Error("bindAll must be passed function names");return y(b,function(b){a[b]=x.bind(a[b],a)}),a},x.memoize=function(a,b){var c={};return b||(b=x.identity),function(){var d=b.apply(this,arguments);return x.has(c,d)?c[d]:c[d]=a.apply(this,arguments)}},x.delay=function(a,b){var c=h.call(arguments,2);return setTimeout(function(){return a.apply(null,c)},b)},x.defer=function(a){return x.delay.apply(x,[a,1].concat(h.call(arguments,1)))},x.throttle=function(a,b,c){var d,e,f,g=null,h=0;c||(c={});var i=function(){h=new Date,g=null,f=a.apply(d,e)};return function(){var j=new Date;h||c.leading!==!1||(h=j);var k=b-(j-h);return d=this,e=arguments,0>=k?(clearTimeout(g),g=null,h=j,f=a.apply(d,e)):g||c.trailing===!1||(g=setTimeout(i,k)),f}},x.debounce=function(a,b,c){var d,e=null;return function(){var f=this,g=arguments,h=function(){e=null,c||(d=a.apply(f,g))},i=c&&!e;return clearTimeout(e),e=setTimeout(h,b),i&&(d=a.apply(f,g)),d}},x.once=function(a){var b,c=!1;return function(){return c?b:(c=!0,b=a.apply(this,arguments),a=null,b)}},x.wrap=function(a,b){return function(){var c=[a];return g.apply(c,arguments),b.apply(this,c)}},x.compose=function(){var a=arguments;return function(){for(var b=arguments,c=a.length-1;c>=0;c--)b=[a[c].apply(this,b)];return b[0]}},x.after=function(a,b){return function(){return--a<1?b.apply(this,arguments):void 0}},x.keys=v||function(a){if(a!==Object(a))throw new TypeError("Invalid object");var b=[];for(var c in a)x.has(a,c)&&b.push(c);return b},x.values=function(a){var b=[];for(var c in a)x.has(a,c)&&b.push(a[c]);return b},x.pairs=function(a){var b=[];for(var c in a)x.has(a,c)&&b.push([c,a[c]]);return b},x.invert=function(a){var b={};for(var c in a)x.has(a,c)&&(b[a[c]]=c);return b},x.functions=x.methods=function(a){var b=[];for(var c in a)x.isFunction(a[c])&&b.push(c);return b.sort()},x.extend=function(a){return y(h.call(arguments,1),function(b){if(b)for(var c in b)a[c]=b[c]}),a},x.pick=function(a){var b={},c=i.apply(d,h.call(arguments,1));return y(c,function(c){c in a&&(b[c]=a[c])}),b},x.omit=function(a){var b={},c=i.apply(d,h.call(arguments,1));for(var e in a)x.contains(c,e)||(b[e]=a[e]);return b},x.defaults=function(a){return y(h.call(arguments,1),function(b){if(b)for(var c in b)void 0===a[c]&&(a[c]=b[c])}),a},x.clone=function(a){return x.isObject(a)?x.isArray(a)?a.slice():x.extend({},a):a},x.tap=function(a,b){return b(a),a};var F=function(a,b,c,d){if(a===b)return 0!==a||1/a==1/b;if(null==a||null==b)return a===b;a instanceof x&&(a=a._wrapped),b instanceof x&&(b=b._wrapped);var e=j.call(a);if(e!=j.call(b))return!1;switch(e){case"[object String]":return a==String(b);case"[object Number]":return a!=+a?b!=+b:0==a?1/a==1/b:a==+b;case"[object Date]":case"[object Boolean]":return+a==+b;case"[object RegExp]":return a.source==b.source&&a.global==b.global&&a.multiline==b.multiline&&a.ignoreCase==b.ignoreCase}if("object"!=typeof a||"object"!=typeof b)return!1;for(var f=c.length;f--;)if(c[f]==a)return d[f]==b;var g=a.constructor,h=b.constructor;if(g!==h&&!(x.isFunction(g)&&g instanceof g&&x.isFunction(h)&&h instanceof h))return!1;c.push(a),d.push(b);var i=0,k=!0;if("[object Array]"==e){if(i=a.length,k=i==b.length)for(;i--&&(k=F(a[i],b[i],c,d)););}else{for(var l in a)if(x.has(a,l)&&(i++,!(k=x.has(b,l)&&F(a[l],b[l],c,d))))break;if(k){for(l in b)if(x.has(b,l)&&!i--)break;k=!i}}return c.pop(),d.pop(),k};x.isEqual=function(a,b){return F(a,b,[],[])},x.isEmpty=function(a){if(null==a)return!0;if(x.isArray(a)||x.isString(a))return 0===a.length;for(var b in a)if(x.has(a,b))return!1;return!0},x.isElement=function(a){return!(!a||1!==a.nodeType)},x.isArray=u||function(a){return"[object Array]"==j.call(a)},x.isObject=function(a){return a===Object(a)},y(["Arguments","Function","String","Number","Date","RegExp"],function(a){x["is"+a]=function(b){return j.call(b)=="[object "+a+"]"}}),x.isArguments(arguments)||(x.isArguments=function(a){return!(!a||!x.has(a,"callee"))}),"function"!=typeof/./&&(x.isFunction=function(a){return"function"==typeof a}),x.isFinite=function(a){return isFinite(a)&&!isNaN(parseFloat(a))},x.isNaN=function(a){return x.isNumber(a)&&a!=+a},x.isBoolean=function(a){return a===!0||a===!1||"[object Boolean]"==j.call(a)},x.isNull=function(a){return null===a},x.isUndefined=function(a){return void 0===a},x.has=function(a,b){return k.call(a,b)},x.noConflict=function(){return a._=b,this},x.identity=function(a){return a},x.times=function(a,b,c){for(var d=Array(Math.max(0,a)),e=0;a>e;e++)d[e]=b.call(c,e);return d},x.random=function(a,b){return null==b&&(b=a,a=0),a+Math.floor(Math.random()*(b-a+1))};var G={escape:{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#x27;","/":"&#x2F;"}};G.unescape=x.invert(G.escape);var H={escape:new RegExp("["+x.keys(G.escape).join("")+"]","g"),unescape:new RegExp("("+x.keys(G.unescape).join("|")+")","g")};x.each(["escape","unescape"],function(a){x[a]=function(b){return null==b?"":(""+b).replace(H[a],function(b){return G[a][b]})}}),x.result=function(a,b){if(null==a)return void 0;var c=a[b];return x.isFunction(c)?c.call(a):c},x.mixin=function(a){y(x.functions(a),function(b){var c=x[b]=a[b];x.prototype[b]=function(){var a=[this._wrapped];return g.apply(a,arguments),M.call(this,c.apply(x,a))}})};var I=0;x.uniqueId=function(a){var b=++I+"";return a?a+b:b},x.templateSettings={evaluate:/<%([\s\S]+?)%>/g,interpolate:/<%=([\s\S]+?)%>/g,escape:/<%-([\s\S]+?)%>/g};var J=/(.)^/,K={"'":"'","\\":"\\","\r":"r","\n":"n","	":"t","\u2028":"u2028","\u2029":"u2029"},L=/\\|'|\r|\n|\t|\u2028|\u2029/g;x.template=function(a,b,c){var d;c=x.defaults({},c,x.templateSettings);var e=new RegExp([(c.escape||J).source,(c.interpolate||J).source,(c.evaluate||J).source].join("|")+"|$","g"),f=0,g="__p+='";a.replace(e,function(b,c,d,e,h){return g+=a.slice(f,h).replace(L,function(a){return"\\"+K[a]}),c&&(g+="'+\n((__t=("+c+"))==null?'':_.escape(__t))+\n'"),d&&(g+="'+\n((__t=("+d+"))==null?'':__t)+\n'"),e&&(g+="';\n"+e+"\n__p+='"),f=h+b.length,b}),g+="';\n",c.variable||(g="with(obj||{}){\n"+g+"}\n"),g="var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};\n"+g+"return __p;\n";try{d=new Function(c.variable||"obj","_",g)}catch(h){throw h.source=g,h}if(b)return d(b,x);var i=function(a){return d.call(this,a,x)};return i.source="function("+(c.variable||"obj")+"){\n"+g+"}",i},x.chain=function(a){return x(a).chain()};var M=function(a){return this._chain?x(a).chain():a};x.mixin(x),y(["pop","push","reverse","shift","sort","splice","unshift"],function(a){var b=d[a];x.prototype[a]=function(){var c=this._wrapped;return b.apply(c,arguments),"shift"!=a&&"splice"!=a||0!==c.length||delete c[0],M.call(this,c)}}),y(["concat","join","slice"],function(a){var b=d[a];x.prototype[a]=function(){return M.call(this,b.apply(this._wrapped,arguments))}}),x.extend(x.prototype,{chain:function(){return this._chain=!0,this},value:function(){return this._wrapped}})}.call(this);var SolverNode=function(a,b,c,d,e,f,g){this.matrix=a,this.parent=b,this.movableX=c,this.movableY=d,this.direction=e,this.totalCost=f,this.heuristic=0,this.moves=g};SolverNode.prototype.calcHueristic=function(){var a=0,b=0,c=0,d=0,e=0,f=0,g=0;for(b=this.matrix.length-1;b>=0;b--)for(c=this.matrix[b].length-1;c>=0;c--)5===this.matrix[b][c]&&(d=b,e=c);for(this.movableX>d?(f=d,g=this.movableX):(f=this.movableX,g=d),b=g;b>=f;b--)(0!==this.matrix[b][this.movableY]||9!==this.matrix[b][this.movableY])&&a++;for(this.movableiY>e?(f=e,g=this.movableY):(f=this.movableY,g=e),b=g;b>=f;b--)(0!==this.matrix[this.movableX][b]||9!==this.matrix[this.movableX][b])&&a++;a+=Math.abs(this.movableX-d),a+=Math.abs(this.movableY-e),this.movableX===d&&(a=-3),this.movableY===e&&(a-=3),this.heuristic=a
},SolverNode.prototype.calcTotalCost=function(){this.totalCost=this.moves+this.heuristic};var Solver=function(a,b,c,d){this.open=[],this.close=[],this.moves=0,this.movableX=c,this.movableY=d,this.matrixI=a,this.matrixF=b;var e=new SolverNode(Phaser.Utils.extend(!0,[],a),null,c,d,null,0,0);this.open.push(e)};Solver.prototype.checkClosed=function(a){var b=0;for(b=this.close.length-1;b>=0;b--)if(this.close[b].matrix.equals(a))return!0;return!1},Solver.prototype.solve=function(){for(;!this.open[this.open.length-1].matrix.equals(this.matrixF)&&this.open.length>0;){var a=this.open.pop();this.close.push(Phaser.Utils.extend(!0,{},a)),this.moves++,this.swap(a,"left"),this.swap(a,"up"),this.swap(a,"right"),this.swap(a,"down"),this.open.sort(function(a,b){return a.totalCost>b.totalCost?-1:a.totalCost<b.totalCost?1:0})}return console.log("Solved!!"),this.open.pop()},Solver.prototype.swap=function(a,b){var c=Phaser.Utils.extend(!0,{},a),d=a.matrix[a.movableX][a.movableY],e=0,f=!1;switch(b){case"up":if(f=c.movableX-1>=0,!f)return;if(e=c.matrix[c.movableX-1][c.movableY],0!==e&&9!==e&&5!==e)return;5===e?(c.matrix[c.movableX][c.movableY]=0,c.isFinal=!0):c.matrix[c.movableX][c.movableY]=e,c.matrix[c.movableX-1][c.movableY]=d,c.movableX--;break;case"down":if(f=c.movableX+1<=9,!f)return;if(e=c.matrix[c.movableX+1][c.movableY],0!==e&&9!==e&&5!==e)return;5===e?(c.matrix[c.movableX][c.movableY]=0,c.isFinal=!0):c.matrix[c.movableX][c.movableY]=e,c.matrix[c.movableX+1][c.movableY]=d,c.movableX++;break;case"left":if(f=c.movableY-1>=0,!f)return;if(e=c.matrix[c.movableX][c.movableY-1],0!==e&&9!==e&&5!==e)return;5===e?(c.matrix[c.movableX][c.movableY]=0,c.isFinal=!0):c.matrix[c.movableX][c.movableY]=e,c.matrix[c.movableX][c.movableY-1]=d,c.movableY--;break;case"right":if(f=c.movableY+1<=9,!f)return;if(e=c.matrix[c.movableX][c.movableY+1],0!==e&&9!==e&&5!==e)return;5===e?(c.matrix[c.movableX][c.movableY]=0,c.isFinal=!0):c.matrix[c.movableX][c.movableY]=e,c.matrix[c.movableX][c.movableY+1]=d,c.movableY++}c.moves++;var g=new SolverNode(c.matrix,a,c.movableX,c.movableY,b,c.totalCost,c.moves);g.isFinal=c.isFinal,g.calcHueristic(),g.calcTotalCost(),this.checkClosed(g.matrix)||this.open.push(g)};var Grid=function(a,b,c,d,e,f,g,h){Phaser.Group.call(this,a),this.game=a,this.rows=b,this.columns=c,this.WIDTH=d,this.HEIGHT=e,this.margin=f,this.square=g,this.draw=h,this.masterMatrix=[],this.cleanMasterMatrix(),this.movableSprite={},this.movableLayers=[],this.unMovableLayers=[],this.finalLayers=[],this.fogLayers=[],this.enemiesLayers=[],this.collectableLayers=[],this.canMove=!1,this.square&&(gameWidth>gameHeight?(this.WIDTH=gameHeight,this.HEIGHT=gameHeight):(this.WIDTH=gameWidth,this.HEIGHT=gameWidth)),this.cellWidth=(this.WIDTH-2*this.margin)/this.columns,this.cellHeight=(this.HEIGHT-2*this.margin)/this.rows,this.limitTop=this.margin,this.limitBottom=this.cellHeight*this.rows+this.margin,this.limitRight=this.cellWidth*this.columns+this.margin,this.limitLeft=this.margin,this.draw&&this.drawGrid(),this.createMarker()};Grid.prototype=Object.create(Phaser.Group.prototype),Grid.prototype.constructor=Grid,Grid.prototype.update=function(){Phaser.Group.prototype.update.apply(this),this.updateMarker()},Grid.prototype.snapToGrid=function(a,b){return b?Math.round((a-this.margin%this.cellWidth)/this.cellWidth)*this.cellWidth+this.margin%this.cellWidth:Math.round((a-this.margin%this.cellHeight)/this.cellHeight)*this.cellHeight+this.margin%this.cellHeight},Grid.prototype.cleanMasterMatrix=function(){for(var a=this.rows-1;a>=0;a--){this.masterMatrix[a]=[];for(var b=this.columns-1;b>=0;b--)this.masterMatrix[a][b]=0}},Grid.prototype.updateFog=function(){var a={},b=0,c=0,d=0,e=0,f=!1,g=!1,h=!1,i=!1,j=!1,k=!1,l=!1,m=!1,n=!1;for(d=this.masterMatrix.length-1;d>=0;d--)for(e=this.masterMatrix[d].length-1;e>=0;e--)5===this.masterMatrix[d][e]&&(b=d,c=e);for(d=this.fogLayers.length-1;d>=0;d--)for(e=this.fogLayers[d].length-1;e>=0;e--)a=this.fogLayers[d].getAt(e),f=a.indexX===b&&a.indexY===c,g=a.indexX===b-1&&a.indexY===c,h=a.indexX===b+1&&a.indexY===c,i=a.indexX===b&&a.indexY===c-1,j=a.indexX===b&&a.indexY===c+1,k=a.indexX===b-1&&a.indexY===c-1,l=a.indexX===b-1&&a.indexY===c+1,m=a.indexX===b+1&&a.indexY===c-1,n=a.indexX===b+1&&a.indexY===c+1,f||g||h||i||j||k||l||m||n?a.kill():a.visible||(a.revive(),a.alpha=.5)},Grid.prototype.updateMasterMatrix=function(){var a={},b=[];this.cleanMasterMatrix();for(var c=this.length-1;c>=0;c--)if(this.getAt(c).hasOwnProperty("matrix")&&"fog"!==this.getAt(c).type){a=this.getAt(c),b=a.matrix;for(var d=b.length-1;d>=0;d--){var e=Math.floor(d/Math.pow(10,1)%10),f=Math.floor(d/Math.pow(10,0)%10);0!==b[d]&&9!==b[d]&&(this.masterMatrix[e][f]=b[d])}}this.updateFog()},Grid.prototype.drawGrid=function(){var a,b={};for(this.bdmGrid=game.add.bitmapData(this.WIDTH,this.HEIGHT),a=0;a<=this.columns;a++)this.bdmGrid.ctx.moveTo(a*this.cellWidth+this.margin,this.margin),this.bdmGrid.ctx.lineTo(a*this.cellWidth+this.margin,this.HEIGHT-this.margin);for(a=0;a<=this.rows;a++)this.bdmGrid.ctx.moveTo(this.margin,a*this.cellHeight+this.margin),this.bdmGrid.ctx.lineTo(this.WIDTH-this.margin,a*this.cellHeight+this.margin);this.bdmGrid.ctx.strokeStyle="#e3e3e3",this.bdmGrid.ctx.lineWidth=2,this.bdmGrid.ctx.stroke(),b=game.add.sprite(0,0,this.bdmGrid),this.add(b)},Grid.prototype.move=function(a,b){for(var c={},d=a.length-1;d>=0;d--){c=a.getAt(d);var e=game.add.tween(c);e.onStart.add(function(){isMoving=!0}),e.onComplete.add(function(){isMoving=!1});var f=0,g=0,h=0,i=0;if(f=c.x-this.cellWidth,g=c.x+this.cellWidth,h=c.y-this.cellHeight,i=c.y+this.cellHeight,!isMoving)switch(b){case"left":c.x-this.cellWidth/2>=this.limitLeft&&(e.to({x:f},250,Phaser.Easing.Linear.None,!1,0,0,!1),e.start());break;case"up":c.y-this.cellHeight/2>this.limitTop&&(e.to({y:h},250,Phaser.Easing.Linear.None,!1,0,0,!1),e.start());break;case"right":c.x+this.cellWidth/2<this.limitRight&&(e.to({x:g},250,Phaser.Easing.Linear.None,!1,0,0,!1),e.start());break;case"down":c.y+this.cellHeight/2<this.limitBottom&&(e.to({y:i},250,Phaser.Easing.Linear.None,!1,0,0,!1),e.start());break;case"topleft":c.y+this.cellHeight/2<this.limitBottom&&(e.to({x:f,y:h},250,Phaser.Easing.Linear.None,!1,0,0,!1),e.start());break;case"topright":c.y+this.cellHeight/2<this.limitBottom&&(e.to({x:g,y:h},250,Phaser.Easing.Linear.None,!1,0,0,!1),e.start());break;case"bottomleft":c.y+this.cellHeight/2<this.limitBottom&&(e.to({x:f,y:i},250,Phaser.Easing.Linear.None,!1,0,0,!1),e.start());break;case"bottomright":c.y+this.cellHeight/2<this.limitBottom&&(e.to({x:g,y:i},250,Phaser.Easing.Linear.None,!1,0,0,!1),e.start())}}a.moveMatrix(b),this.updateMasterMatrix()},Grid.prototype.addLayer=function(a,b,c,d){var e=new GridLayer(this.game,a,b,c,d,this.margin,this.cellWidth,this.cellHeight);switch(this.add(e),b){case"movable":this.movableSprite=e.getFirstAlive(),this.movableLayers.push(e);break;case"unmovable":this.unMovableLayers.push(e);break;case"final":this.finalLayers.push(e);break;case"enemy":this.enemiesLayers.push(e);break;case"collectable":this.collectableLayers.push(e);break;case"fog":this.fogLayers.push(e)}this.updateMasterMatrix()},Grid.prototype.createMarker=function(){this.marker=game.add.graphics(),this.changeMarkerColor(13382451),this.marker.x=10,this.marker.y=10},Grid.prototype.changeMarkerColor=function(a){this.marker.clear(),this.marker.lineStyle(2,14935011,1),this.marker.drawRect(0,0,this.cellWidth,this.cellHeight),this.marker.beginFill(a,.5),this.marker.drawRect(0,0,this.cellWidth,this.cellHeight),this.marker.endFill()},Grid.prototype.updateMarker=function(){this.canMove=!1;var a=game.input.activePointer.worldX>this.limitLeft,b=game.input.activePointer.worldX<this.limitRight,c=game.input.activePointer.worldY>this.limitTop,d=game.input.activePointer.worldY<this.limitBottom,e=!this.checkLayer(this.marker.x,this.marker.y,1,this.unMovableLayers),f=!this.checkLayer(this.marker.x,this.marker.y,2,this.enemiesLayers),g=this.checkLayer(this.marker.x,this.marker.y,9,this.movableLayers);a&&b&&c&&d&&(this.marker.x=this.snapToGrid(game.input.activePointer.worldX-this.cellWidth/2,!0),this.marker.y=this.snapToGrid(game.input.activePointer.worldY-this.cellHeight/2,!1)),e&&g&&f?(this.changeMarkerColor(5410852),this.canMove=!0):(this.changeMarkerColor(13382451),this.canMove=!1)},Grid.prototype.collect=function(a,b,c,d){for(var e=0,f=0,g=this.snapToGrid(a,!0),h=this.snapToGrid(b,!1),i=[],j=[],k=c.length-1;k>=0;k--){i=c[k].matrix;for(var l=i.length-1;l>=0;l--)i[l]===d&&(e=Math.floor(l/Math.pow(10,0)%10),f=Math.floor(l/Math.pow(10,1)%10),e=this.snapToGrid((e+1)*this.cellWidth,!0),f=this.snapToGrid((f+1)*this.cellHeight,!1),g===e&&h===f&&(c[k].matrix[l]=0));j.push(c[k].getFirstAlive())}return j},Grid.prototype.checkLayer=function(a,b,c,d){for(var e=0,f=0,g=this.snapToGrid(a,!0),h=this.snapToGrid(b,!1),i=[],j=d.length-1;j>=0;j--){i=d[j].matrix;for(var k=i.length-1;k>=0;k--)if(i[k]===c&&(e=Math.floor(k/Math.pow(10,0)%10),f=Math.floor(k/Math.pow(10,1)%10),e=this.snapToGrid((e+1)*this.cellWidth,!0),f=this.snapToGrid((f+1)*this.cellHeight,!1),g===e&&h===f))return!0}return!1};var GridLayer=function(a,b,c,d,e,f,g,h){Phaser.Group.call(this,a),this.game=a,this.type=c,this.matrix=b,this.frameNames=[],this.margin=f,this.cellWidth=g,this.cellHeight=h,this.frameNames=null===e?_.keys(this.game.cache._images[d].frameData._frameNames):e;for(var i={},j=b.length-1;j>=0;j--)if(i={},0!==b[j]&&9!==b[j]){var k=Math.floor(j/Math.pow(10,0)%10),l=Math.floor(j/Math.pow(10,1)%10),m=Math.round(((k+1)*this.cellWidth-this.margin%this.cellWidth)/this.cellWidth)*this.cellWidth+this.margin%this.cellWidth,n=Math.round(((l+1)*this.cellHeight-this.margin%this.cellHeight)/this.cellHeight)*this.cellHeight+this.margin%this.cellHeight;switch(b[j]){case 2:console.log("x: "+k+" y: "+l),i=new Enemy(this.game,m,n,this.cellWidth,this.cellHeight,d,j,l,k),i.frameName=this.frameNames[b[j]];break;case 6:i=new Fog(this.game,m,n,this.cellWidth,this.cellHeight,j,l,k);break;default:i=this.game.add.sprite(m,n,d),i.frameName=this.frameNames[b[j]]}var o=this.cellWidth/i.width;i.scale.set(o),this.add(i)}};GridLayer.prototype=Object.create(Phaser.Group.prototype),GridLayer.prototype.constructor=GridLayer,GridLayer.prototype.moveMatrix=function(a){for(var b=0,c=0,d=this.matrix.length-1;d>=0;d--)0!==this.matrix[d]&&9!==this.matrix[d]&&(b=d,c=this.matrix[d]),this.matrix[d]=0;switch(a){case"left":b--;break;case"up":b-=10;break;case"right":b++;break;case"down":b+=10;break;case"topleft":b-=11;break;case"topright":b-=9;break;case"bottomleft":b+=9;break;case"bottomright":b+=11}this.matrix[b]=c,5===c&&(b>=10&&(b%10!==9&&(this.matrix[b-9]=9),b%10!==0&&(this.matrix[b-11]=9),this.matrix[b-10]=9),b%10!==9&&(this.matrix[b+1]=9),b%10!==0&&(this.matrix[b-1]=9),90>b&&(b%10!==0&&(this.matrix[b+9]=9),b%10!==9&&(this.matrix[b+11]=9),this.matrix[b+10]=9))};var Enemy=function(a,b,c,d,e,f,g,h,i){Phaser.Sprite.call(this,a,b+d/2,c+e/2,"tiles"),this.awake=!1,this.game=a,this.anchor.set(.5,.5),this.game.add.existing(this),this.name="Enemy-"+g,this.cellWidth=d,this.cellHeight=e,this.indexX=h,this.indexY=i;Math.floor(359*Math.random())+1;this.colorPath="#fff",this.direction="down",this.canMove=!1,this.nodes=[],this.path=game.add.group();for(var j=Math.floor(5*Math.random())+1,k=j;k>0;k--)this.angle+=90};Enemy.prototype=Object.create(Phaser.Sprite.prototype),Enemy.prototype.constructor=Enemy,Enemy.prototype.updateDirection=function(){0===this.angle?this.direction="down":90===this.angle?this.direction="left":-90===this.angle?this.direction="right":-180===this.angle&&(this.direction="up")},Enemy.prototype.turn=function(){if(this.awake){this.nodes=[],this.updateDirection();var a=Phaser.Utils.extend(!0,[],this.parent.parent.masterMatrix);a[this.indexX][this.indexY]=0;for(var b=a.length-1;b>=0;b--)for(var c=a[b].length-1;c>=0;c--)5===a[b][c]&&(a[b][c]=2);this.solver=new Solver(this.parent.parent.masterMatrix,a,this.indexX,this.indexY);var d=this.solver.solve();for(this.nodes=[],this.nodes.push(d);null!==d.parent;)this.nodes.push(d.parent),d=d.parent;var e=this.nodes[this.nodes.length-2].direction;if(this.direction===e)this.indexX=this.nodes[this.nodes.length-2].movableX,this.indexY=this.nodes[this.nodes.length-2].movableY,this.move(e);else switch(e){case"up":"right"===this.direction?this.rotate(!1,!1):this.rotate(!0,!1);break;case"down":"left"===this.direction?this.rotate(!1,!1):this.rotate(!1,!1);break;case"left":"down"===this.direction?this.rotate(!0,!1):this.rotate(!1,!1);break;case"right":"up"===this.direction?this.rotate(!0,!1):this.rotate(!1,!1)}}},Enemy.prototype.rotate=function(a,b){var c=this.game.add.tween(this),d=this.angle;a?d+=b?180:90:d-=b?180:90;var e=this;c.onStart.add(function(){playerTurn=!1}),c.to({angle:d},500,Phaser.Easing.Linear.None,!1,0,0,!1),c.start(),c.onComplete.add(function(){b||(e.checkPlayer(),e.drawPath()),playerTurn=!0})},Enemy.prototype.move=function(a){this.parent.parent.move(this.parent,a),this.checkPlayer(),this.drawPath()},Enemy.prototype.drawPath=function(){console.log("drawPath"),this.path.callAll("kill");for(var a=this.nodes.length-2;a>0;a--){var b=this.parent.parent.snapToGrid((this.nodes[a].movableX+1)*this.cellWidth,!0),c=this.parent.parent.snapToGrid((this.nodes[a].movableY+1)*this.cellWidth,!0),d=this.path.getFirstExists(!1);if(d)d.revive(),d.x=c+this.cellWidth/2-5,d.y=b+this.cellHeight/2-5;else{var e=game.add.bitmapData(10,10);e.context.fillStyle=this.colorPath,e.context.fillRect(0,0,50,50);var f=game.add.sprite(0,0,e);f.alpha=.4,f.x=c+this.cellWidth/2-5,f.y=b+this.cellHeight/2-5,this.path.add(f)}}},Enemy.prototype.checkAwake=function(){if(!this.awake){var a,b,c,d,e,f,g,h,i=0,j=0,k=0,l=0,m=this.parent.parent.masterMatrix;for(i=m.length-1;i>=0;i--)for(j=m[i].length-1;j>=0;j--)5===m[i][j]&&(k=i,l=j);c=k-1===this.indexX&&l===this.indexY,d=k+1===this.indexX&&l===this.indexY,a=l-1===this.indexY&&k===this.indexX,b=l+1===this.indexY&&k===this.indexX&&l!==this.indexY,e=k-1===this.indexX&&l-1===this.indexY,f=k+1===this.indexX&&l-1===this.indexY,h=k-1===this.indexX&&l+1===this.indexY,g=k+1===this.indexX&&l+1===this.indexY,(a||b||c||d||e||f||g||h)&&(this.awake=!0)}},Enemy.prototype.checkPlayer=function(){this.updateDirection(),console.log("CheckPlayer");var a=0,b=!1,c=!1;if(this.nodes[this.nodes.length-2].direction!==this.direction)return!1;for(a=this.nodes.length-1;a>0;a--)if(b=this.nodes[a].direction!==this.nodes[a-1].direction,c=null!==this.nodes[a].direction,b&&c)return;powerUps>0?(this.rotate(!0,!0),powerUps--):BUSTED=!0};var Fog=function(a,b,c,d,e,f,g,h){var i=game.add.bitmapData(d,e);i.context.fillStyle="0x000000",i.context.fillRect(0,0,d,d),Phaser.Sprite.call(this,a,b,c,i),this.game=a,this.name="Fog-"+f,this.cellWidth=d,this.cellHeight=e,this.indexX=g,this.indexY=h,this.game.add.existing(this)};Fog.prototype=Object.create(Phaser.Sprite.prototype),Fog.prototype.constructor=Fog,function(){"use strict";function a(){}a.prototype={preload:function(){this.load.image("loadingBG","assets/img/LoadingBG.png"),this.load.image("loading","assets/img/Loading.png")},create:function(){game.input.maxPointers=1,game.state.start("preloader")}},BootS=a}(),function(){"use strict";function a(){this.preloadBarBg=null,this.preloadBar=null}a.prototype={preload:function(){game.stage.backgroundColor="#333333",this.preloadBarBg=this.add.sprite(game.world.centerX,game.world.centerY,"loadingBG"),this.preloadBar=this.add.sprite(game.world.centerX+4,game.world.centerY,"loading"),this.preloadBarBg.anchor.setTo(.5,.5),this.preloadBar.anchor.setTo(.5,.5),this.load.image("title","assets/img/title.png"),game.load.audio("sfx",["assets/sound/die.mp3","assets/sound/die.ogg"]),game.load.audio("soundtrack",["assets/sound/soundtrack.mp3","assets/sound/soundtrack.ogg"]),this.load.setPreloadSprite(this.preloadBar),this.load.atlasJSONHash("buttons","assets/spritesheets/buttons.png","assets/spritesheets/buttons.json"),this.load.atlasJSONHash("tiles","assets/spritesheets/tiles.png","assets/spritesheets/tiles.json")},create:function(){this.preloadBar.cropEnabled=!1,game.state.start("mainmenu")}},PreloaderS=a}(),function(){"use strict";function a(){}a.prototype={create:function(){game.stage.backgroundColor="#333333",this.LIGHT_RADIUS=gameWidth/2,this.highScore=0,this.lastScore=0,this.getScore(),this.enterKey=game.input.keyboard.addKey(Phaser.Keyboard.ENTER),this.enterKey.onDown.add(function(){this.startState("play")},this),this.tutorialKey=game.input.keyboard.addKey(Phaser.Keyboard.H),this.tutorialKey.onDown.add(function(){this.startState("tutorial")},this),this.bttPlay=game.add.button(game.world.centerX,game.world.centerY,"buttons",function(){this.startState("play")},this,"bttStartHover","bttStartInactive","bttStartActive"),this.bttAbout=game.add.button(game.world.centerX-200,game.world.centerY+200,"buttons",function(){this.startState("credits")},this,"bttInfoHover","bttInfoInactive","bttInfoActive"),this.bttLeader=game.add.button(game.world.centerX+200,game.world.centerY+200,"buttons",function(){this.startState("leaderboards")},this,"bttLeaderHover","bttLeaderInactive","bttLeaderActive"),this.bttTutorial=game.add.button(game.world.centerX-10,game.world.centerY+200,"buttons",function(){this.startState("tutorial")},this,"bttAboutHover","bttAboutInactive","bttAboutActive"),this.bttSettings=game.add.button(game.world.centerX+10,game.world.centerY+200,"buttons",function(){this.startState("mainmenu")},this,"bttSettingsHover","bttSettingsInactive","bttSettingsActive");var a=0;a=gameWidth>gameHeight?gameHeight:gameWidth,this.bttPlay.scale.set(a/6/this.bttPlay.width),this.bttAbout.scale.set(a/10/this.bttAbout.width),this.bttLeader.scale.set(a/10/this.bttLeader.width),this.bttTutorial.scale.set(a/10/this.bttTutorial.width),this.bttSettings.scale.set(a/10/this.bttSettings.width),this.bttPlay.x=game.world.centerX,this.bttPlay.y=game.world.centerY,this.bttAbout.x=game.world.centerX-(this.bttAbout.width+20),this.bttAbout.y=game.world.centerY+3*this.bttAbout.height,this.bttLeader.x=game.world.centerX+(this.bttLeader.width+20),this.bttLeader.y=game.world.centerY+3*this.bttLeader.height,this.bttTutorial.x=game.world.centerX-(this.bttLeader.width+5),this.bttSettings.x=game.world.centerX+(this.bttLeader.width+5),this.bttTutorial.y=game.world.centerY+3*this.bttLeader.height,this.bttSettings.y=game.world.centerY+3*this.bttLeader.height,this.title=game.add.sprite(game.world.centerX,game.world.centerY-this.bttPlay.height+10,"title"),this.title.scale.set(a/3/this.title.width),this.title.anchor.setTo(.5,.5),this.bttPlay.anchor.setTo(.5,.5),this.bttAbout.anchor.setTo(1,.5),this.bttLeader.anchor.setTo(0,.5),this.bttTutorial.anchor.setTo(0,.5),this.bttSettings.anchor.setTo(1,.5);var b=game.add.bitmapData(gameWidth,gameHeight);b.context.fillStyle="rgba(50, 50, 50, 1.0)",b.context.fillRect(0,0,gameWidth,gameHeight);var c=game.add.sprite(0,0,b),d=game.add.tween(c);d.onStart.add(function(){isMoving=!0}),d.onComplete.add(function(){isMoving=!1}),d.to({alpha:0},500,Phaser.Easing.Linear.None,!1,0,0,!1),d.start()},startState:function(a){var b=game.add.bitmapData(gameWidth,gameHeight);b.context.fillStyle="rgba(50, 50, 50, 1.0)",b.context.fillRect(0,0,gameWidth,gameHeight);var c=game.add.sprite(0,0,b);c.alpha=0;var d=game.add.tween(c);d.to({alpha:1},500,Phaser.Easing.Linear.None,!1,0,0,!1),d.start(),d.onComplete.add(function(){game.state.start(a)})},getScore:function(){this.lastScore=localStorage.getItem("lastScore"),this.highScore=localStorage.getItem("highScore"),("undefined"==typeof this.highScore||null==this.highScore||isNaN(this.highScore))&&(this.highScore=0,this.lastScore=0,localStorage.setItem("highScore",this.highScore),localStorage.setItem("lastScore",this.lastScore)),this.highScore=parseInt(this.highScore,10),this.lastScore=parseInt(this.lastScore,10),this.highScore<this.lastScore&&(this.highScore=this.lastScore,localStorage.setItem("highScore",this.lastScore))}},MainMenuS=a}(),function(){"use strict";function a(){}a.prototype={create:function(){game.stage.backgroundColor="#333333",this.slideIndex=0,this.enterKey=game.input.keyboard.addKey(Phaser.Keyboard.ENTER),this.enterKey.onDown.add(function(){this.startState("play")},this),this.bttBack=game.add.button(game.world.centerX-200,game.world.centerY+200,"buttons",function(){this.manageButtons(!1)},this,"bttBackHover","bttBackInactive","bttBackActive"),this.bttPlay=game.add.button(game.world.centerX+200,game.world.centerY+200,"buttons",function(){this.manageButtons(!0)},this,"bttPlayHover","bttPlayInactive","bttPlayActive");var a=0;a=gameWidth>gameHeight?gameHeight:gameWidth,this.bttBack.scale.set(a/10/this.bttBack.width),this.bttBack.x=game.world.centerX-1.5*this.bttBack.width,this.bttBack.y=game.world.centerY+3*this.bttBack.height,this.bttPlay.scale.set(a/10/this.bttPlay.width),this.bttPlay.x=game.world.centerX+1.5*this.bttPlay.width,this.bttPlay.y=game.world.centerY+3*this.bttPlay.height,this.textOne=game.add.text(game.world.centerX,game.world.centerY,"What you control",{font:this.bttBack.height+"px Source Code Pro",fill:"#f0f0f0",align:"left"}),this.textTwo=game.add.text(0,game.world.centerY,"What you fear",{font:this.bttBack.height+"px Source Code Pro",fill:"#f0f0f0",align:"left"}),this.textThree=game.add.text(0,game.world.centerY,"What you can't pass",{font:this.bttBack.height+"px Source Code Pro",fill:"#f0f0f0",align:"left"}),this.textFour=game.add.text(0,game.world.centerY,"What protects you",{font:this.bttBack.height+"px Source Code Pro",fill:"#f0f0f0",align:"left"}),this.textFive=game.add.text(0,game.world.centerY,"Your goal",{font:this.bttBack.height+"px Source Code Pro",fill:"#f0f0f0",align:"left"}),this.textTwo.x=game.world.width+this.textTwo.width,this.textThree.x=game.world.width+this.textThree.width,this.textFour.x=game.world.width+this.textFour.width,this.textFive.x=game.world.width+this.textFive.width,this.player=game.add.sprite(game.world.centerX,game.world.centerY,"tiles"),this.enemy=game.add.sprite(game.world.centerX,game.world.centerY,"tiles"),this.wall=game.add.sprite(game.world.centerX,game.world.centerY,"tiles"),this.shield=game.add.sprite(game.world.centerX,game.world.centerY,"tiles"),this.exit=game.add.sprite(game.world.centerX,game.world.centerY,"tiles"),this.enemy.x=game.world.width+this.enemy.width,this.wall.x=game.world.width+this.wall.width,this.shield.x=game.world.width+this.shield.width,this.exit.x=game.world.width+this.exit.width,this.player.frameName="Player",this.enemy.frameName="Enemy",this.wall.frameName="Wall",this.shield.frameName="Shield",this.exit.frameName="Exit",this.textOne.anchor.setTo(.5,0),this.textTwo.anchor.setTo(.5,0),this.textThree.anchor.setTo(.5,0),this.textFour.anchor.setTo(.5,0),this.textFive.anchor.setTo(.5,0),this.bttBack.anchor.setTo(.5,0),this.bttPlay.anchor.setTo(.5,0),this.player.anchor.setTo(.5,1),this.enemy.anchor.setTo(.5,1),this.wall.anchor.setTo(.5,1),this.shield.anchor.setTo(.5,1),this.exit.anchor.setTo(.5,1);var b=game.add.bitmapData(gameWidth,gameHeight);b.context.fillStyle="rgba(50, 50, 50, 1.0)",b.context.fillRect(0,0,gameWidth,gameHeight);var c=game.add.sprite(0,0,b),d=game.add.tween(c);d.onStart.add(function(){isMoving=!0}),d.onComplete.add(function(){isMoving=!1}),d.to({alpha:0},500,Phaser.Easing.Linear.None,!1,0,0,!1),d.start()},startState:function(a){var b=game.add.bitmapData(gameWidth,gameHeight);b.context.fillStyle="rgba(50, 50, 50, 1.0)",b.context.fillRect(0,0,gameWidth,gameHeight);var c=game.add.sprite(0,0,b);c.alpha=0;var d=game.add.tween(c);d.to({alpha:1},500,Phaser.Easing.Linear.None,!1,0,0,!1),d.start(),d.onComplete.add(function(){game.state.start(a)})},outSlide:function(a,b){var c=0;c=b?game.world.width/2*-1:game.world.width+a.width;game.add.tween(a).to({x:c},500,Phaser.Easing.Linear.None).start()},inSlide:function(a){game.add.tween(a).to({x:game.world.centerX},500,Phaser.Easing.Linear.None).start()},manageButtons:function(a){if(a)switch(this.slideIndex++,this.slideIndex){case 1:this.outSlide(this.player,a),this.outSlide(this.textOne,a),this.inSlide(this.enemy),this.inSlide(this.textTwo);break;case 2:this.outSlide(this.enemy,a),this.outSlide(this.textTwo,a),this.inSlide(this.wall),this.inSlide(this.textThree);break;case 3:this.outSlide(this.wall,a),this.outSlide(this.textThree,a),this.inSlide(this.shield),this.inSlide(this.textFour);break;case 4:this.outSlide(this.shield,a),this.outSlide(this.textFour,a),this.inSlide(this.exit),this.inSlide(this.textFive);break;default:this.startState("play")}else switch(this.slideIndex--,this.slideIndex){case 0:this.outSlide(this.enemy,a),this.outSlide(this.textTwo,a),this.inSlide(this.player),this.inSlide(this.textOne);break;case 1:this.outSlide(this.wall,a),this.outSlide(this.textThree,a),this.inSlide(this.enemy),this.inSlide(this.textTwo);break;case 2:this.outSlide(this.shield,a),this.outSlide(this.textFour,a),this.inSlide(this.wall),this.inSlide(this.textThree);break;case 3:this.outSlide(this.exit,a),this.outSlide(this.textFive,a),this.inSlide(this.shield),this.inSlide(this.textFour);break;default:this.startState("mainmenu")}}},TutorialS=a}(),function(){"use strict";function a(){}a.prototype={create:function(){game.stage.backgroundColor="#333333",this.enterKey=game.input.keyboard.addKey(Phaser.Keyboard.ENTER),this.enterKey.onDown.add(function(){this.startState("play")},this),this.bttBack=game.add.button(game.world.centerX-200,game.world.centerY+200,"buttons",function(){this.startState("mainmenu")},this,"bttBackHover","bttBackInactive","bttBackActive"),this.bttPlay=game.add.button(game.world.centerX+200,game.world.centerY+200,"buttons",function(){this.startState("play")},this,"bttPlayHover","bttPlayInactive","bttPlayActive");var a=0;a=gameWidth>gameHeight?gameHeight:gameWidth,this.bttBack.scale.set(a/10/this.bttBack.width),this.bttBack.x=game.world.centerX-1.5*this.bttBack.width,this.bttBack.y=game.world.centerY+3*this.bttBack.height,this.bttPlay.scale.set(a/10/this.bttPlay.width),this.bttPlay.x=game.world.centerX+1.5*this.bttPlay.width,this.bttPlay.y=game.world.centerY+3*this.bttPlay.height,this.text=game.add.text(game.world.centerX,game.world.centerY,"CRSG\n A one man job\n by Arlefreak \n",{font:this.bttBack.height+"px Source Code Pro",fill:"#f0f0f0",align:"center"}),this.creditsTxt=game.add.text(game.world.centerX,this.world.height-20," Made with Phaser",{font:"15px Source Code Pro",fill:"#ffffff",align:"left"}),this.text.anchor.setTo(.5,.5),this.creditsTxt.anchor.setTo(.5,.5),this.bttBack.anchor.setTo(.5,.5),this.bttPlay.anchor.setTo(.5,.5);var b=game.add.bitmapData(gameWidth,gameHeight);b.context.fillStyle="rgba(50, 50, 50, 1.0)",b.context.fillRect(0,0,gameWidth,gameHeight);var c=game.add.sprite(0,0,b),d=game.add.tween(c);d.onStart.add(function(){isMoving=!0}),d.onComplete.add(function(){isMoving=!1}),d.to({alpha:0},500,Phaser.Easing.Linear.None,!1,0,0,!1),d.start()},startState:function(a){var b=game.add.bitmapData(gameWidth,gameHeight);b.context.fillStyle="rgba(50, 50, 50, 1.0)",b.context.fillRect(0,0,gameWidth,gameHeight);var c=game.add.sprite(0,0,b);c.alpha=0;var d=game.add.tween(c);d.to({alpha:1},500,Phaser.Easing.Linear.None,!1,0,0,!1),d.start(),d.onComplete.add(function(){game.state.start(a)})}},CreditsS=a}(),function(){"use strict";function a(){}a.prototype={create:function(){game.stage.backgroundColor="#333333",this.highScore=0,this.lastScore=0,this.getScore(),console.log("LeaderBoards initiates"),this.enterKey=game.input.keyboard.addKey(Phaser.Keyboard.ENTER),this.enterKey.onDown.add(function(){this.startState("play")},this),this.bttBack=game.add.button(game.world.centerX-200,game.world.centerY+200,"buttons",function(){this.startState("mainmenu")},this,"bttBackHover","bttBackInactive","bttBackActive"),this.bttPlay=game.add.button(game.world.centerX+200,game.world.centerY+200,"buttons",function(){this.startState("play")},this,"bttPlayHover","bttPlayInactive","bttPlayActive"),this.bttGooglePlus=game.add.button(game.world.centerX,game.world.centerY+200,"buttons",function(){gapi.auth.signIn({callback:signinCallback})},this,"bttGooglePlusHover","bttGooglePlusInactive","bttGooglePlusActive");var a=0;a=gameWidth>gameHeight?gameHeight:gameWidth,this.bttBack.scale.set(a/10/this.bttBack.width),this.bttBack.x=game.world.centerX-1.5*this.bttBack.width,this.bttBack.y=game.world.centerY+3*this.bttBack.height,this.bttPlay.scale.set(a/10/this.bttPlay.width),this.bttPlay.x=game.world.centerX+1.5*this.bttPlay.width,this.bttPlay.y=game.world.centerY+3*this.bttPlay.height,this.bttGooglePlus.scale.set(a/10/this.bttGooglePlus.width),this.bttGooglePlus.x=game.world.centerX,this.bttGooglePlus.y=game.world.centerY+3*this.bttGooglePlus.height,this.text=game.add.text(game.world.centerX,game.world.centerY,"High Score\n Loading...\n Last Score\n "+this.lastScore,{font:this.bttBack.height+"px Source Code Pro",fill:"#f0f0f0",align:"center"}),this.text.anchor.setTo(.5,.5),this.bttBack.anchor.setTo(.5,.5),this.bttPlay.anchor.setTo(.5,.5),this.bttGooglePlus.anchor.setTo(.5,.5);var b=game.add.bitmapData(gameWidth,gameHeight);b.context.fillStyle=BUSTED?"rgba(255, 84, 76, 1.0)":"rgba(50, 50, 50, 1.0)",b.context.fillRect(0,0,gameWidth,gameHeight);var c=game.add.sprite(0,0,b),d=game.add.tween(c);d.onStart.add(function(){isMoving=!0}),d.onComplete.add(function(){isMoving=!1}),d.to({alpha:0},500,Phaser.Easing.Linear.None,!1,0,0,!1),d.start(),BUSTED=!1},startState:function(a){var b=game.add.bitmapData(gameWidth,gameHeight);b.context.fillStyle="rgba(50, 50, 50, 1.0)",b.context.fillRect(0,0,gameWidth,gameHeight);var c=game.add.sprite(0,0,b);c.alpha=0;var d=game.add.tween(c);d.to({alpha:1},500,Phaser.Easing.Linear.None,!1,0,0,!1),d.start(),d.onComplete.add(function(){game.state.start(a)})},getScore:function(){var a=this;this.lastScore=localStorage.getItem("lastScore"),this.highScore=1e8,gapi.client.load("games","v1",function(){console.log(gapi.client);var b=gapi.client.games.scores.get({leaderboardId:"CgkIlcH21rkDEAIQBw",playerId:"me",timeSpan:"ALL_TIME"});b.execute(function(b){console.log(b),console.log(b.items[0].scoreValue),a.highScore=b.items[0].scoreValue,a.text.setText("High Score\n"+a.highScore+"\n Last Score\n "+a.lastScore)})}),this.lastScore=parseInt(this.lastScore,10)}},LeaderBoardsS=a}(),function(){"use strict";function a(){}a.prototype={create:function(){playerTurn=!0,game.stage.backgroundColor="#333333",this.fx=game.add.audio("sfx"),this.soundtrack=game.add.audio("soundtrack"),this.game.time.advancedTiming=!0;var a=0;if(a=gameWidth>gameHeight?.05*gameHeight:.05*gameWidth,this.grid=new Grid(game,10,10,gameWidth,gameHeight,a,!0,!0),1!==level)var b=this.genRandomLayers();else var b=this.genLayers();this.TilePowerUpsG=game.add.group();for(var c,d=0;powerUps>d;d++){c=this.TilePowerUpsG.create(160+d,.25*a,"tiles","Shield");var e=.5*a/c.width;c.scale.set(e),c.x=160+d*c.width}for(var d=b.length-1;d>=0;d--){for(var f="layer"+d,g=b[d].length-1;g>=0;g--){var h=b[d][g];switch(h){case 1:f="unmovable";break;case 2:f="enemy";break;case 3:f="final";break;case 4:f="collectable";break;case 5:f="movable";break;case 5:f="movable";break;case 6:f="fog"}}this.grid.addLayer(b[d],f,"tiles",[null,"Wall","Enemy","Exit","Shield","Player"])}this.fpsText=this.game.add.text(game.world.width-50,.25*a,"0",{font:"20px Source Code Pro",fill:"#f0f0f0",align:"center"}),this.levelText=this.game.add.text(50,.25*a,"Level: "+level,{font:"20px Source Code Pro",fill:"#f0f0f0",align:"center"}),this.fpsText.anchor.set(1,0);var e=.5*a/this.fpsText.height;this.fpsText.scale.set(e),this.levelText.scale.set(e),this.escKey=game.input.keyboard.addKey(Phaser.Keyboard.ESC),game.input.onDown.add(this.move,this),this.escKey.onDown.add(function(){this.quitGame("mainmenu",!1)},this);var i=game.add.bitmapData(gameWidth,gameHeight);i.context.fillStyle="rgba(50, 50, 50, 1.0)",i.context.fillRect(0,0,gameWidth,gameHeight);var j=game.add.sprite(0,0,i),k=game.add.tween(j);k.onStart.add(function(){isMoving=!0}),k.onComplete.add(function(){isMoving=!1}),k.to({alpha:0},500,Phaser.Easing.Linear.None,!1,0,0,!1),k.start()},update:function(){0!==this.game.time.fps&&this.fpsText.setText(this.game.time.fps+" FPS"),BUSTED&&(this.quitGame("leaderboards",!0),console.log("BUSTED !"),BUSTED=!1),powerUps<this.TilePowerUpsG.length&&this.TilePowerUpsG.remove(this.TilePowerUpsG.getAt(this.TilePowerUpsG.length-1))
},render:function(){},quitGame:function(a,b){playerTurn=!1;var c=game.add.bitmapData(gameWidth,gameHeight);c.context.fillStyle=b?"rgba(255, 84, 76, 1.0)":"rgba(50, 50, 50, 1.0)",c.context.fillRect(0,0,gameWidth,gameHeight);var d=game.add.sprite(0,0,c);d.alpha=0,b?(console.log("score: "+SCORE),localStorage.setItem("lastScore",SCORE),gapi.client.load("games","v1",function(){console.log("Submiting Score");gapi.client.games.scores.submit({leaderboardId:"CgkIlcH21rkDEAIQBw",score:SCORE})}),SCORE=0,powerUps=0,level=1):(level++,SCORE+=100);var e=game.add.tween(d);e.to({alpha:1},500,Phaser.Easing.Linear.None,!1,0,0,!1),e.start(),e.onComplete.add(function(){game.state.start(a)}),this.grid={},game.time.events.remove(this.timer)}},a.prototype.gameOVerText=function(){var a=game.add.bitmapData(gameWidth,gameHeight);a.context.fillStyle="rgba(50, 50, 50, 1.0)",a.context.fillRect(0,0,gameWidth,gameHeight);var b=game.add.sprite(0,0,a);b.alpha=0;var c=game.add.tween(b);c.to({alpha:1},500,Phaser.Easing.Linear.None,!1,0,0,!1),c.start(),c.onComplete.add(function(){game.state.start("mainmenu")})},a.prototype.genRandomLayers=function(){for(var a=[],b=[2],c=[3,4,5],d=[],e=[],f=[],g=[],h=[],i=[],j=[],k=0,l=20;l>=0;l--)c.push(1);for(var l=level-1;l>0;l--)c.push(2);for(var l=level-1;l>0;l--)b.push(2);for(var l=99;l>=0;l--)d.push(0),e.push(0),f.push(0),g.push(0),h.push(0),i.push(6);for(var l=c.length;l>=0;l--){var m=0;do m=Math.floor(99*Math.random())+1;while(indexOf.call(j,m)>-1);j.push(m)}Phaser.Utils.shuffle(c),Phaser.Utils.shuffle(j);for(var l=c.length-1;l>=0;l--){switch(c[l]){case 1:d[j[l]]=c[l];break;case 2:e[j[l]]=c[l];break;case 3:f[j[l]]=c[l];break;case 4:g[j[l]]=c[l];break;case 5:h[j[l]]=c[l],k=j[l]}l>-1&&j.splice(l,1)}k>=10&&(k%10!==9&&(h[k-9]=9),k%10!==0&&(h[k-11]=9),h[k-10]=9),k%10!==9&&(h[k+1]=9),k%10!==0&&(h[k-1]=9),90>k&&(k%10!==0&&(h[k+9]=9),k%10!==9&&(h[k+11]=9),h[k+10]=9),a.push(i),a.push(d),a.push(e),a.push(f),a.push(g),a.push(h);for(var l=b.length-1;l>=0;l--){for(var n=[],o=100;o>=0;o--)n[o]=0;var p=j.pop();d[p]=0,n[p]=2,a.push(n)}return a},a.prototype.genLayers=function(){for(var a=[],b=[2],c=[3,4],d=[],e=[],f=[],g=[],h=[],i=[],j=[],k=level-1;k>0;k--)b.push(2);for(var k=99;k>=0;k--)d.push(0),e.push(0),f.push(0),g.push(0),h.push(0),i.push(6);for(var k=5;k>=0;k--)d[k+22]=1,d[k+72]=1,d[22+10*k]=1,d[27+10*k]=1;for(var k=d.length-1;k>=0;k--)1===d[k]&&j.push(k);Phaser.Utils.shuffle(c),Phaser.Utils.shuffle(j);for(var k=c.length-1;k>=0;k--){switch(c[k]){case 2:for(var l=[],m=100;m>=0;m--)l[m]=0;var n=j[k];l[n]=2,a.push(l);break;case 3:f[j[k]]=c[k];break;case 4:g[j[k]]=c[k];break;case 5:h[j[k]]=c[k]}d[j[k]]=0,k>-1&&j.splice(k,1)}var o=0;h[o]=5,o>=10&&(o%10!==9&&(h[o-9]=9),o%10!==0&&(h[o-11]=9),h[o-10]=9),o%10!==9&&(h[o+1]=9),o%10!==0&&(h[o-1]=9),90>o&&(o%10!==0&&(h[o+9]=9),o%10!==9&&(h[o+11]=9),h[o+10]=9),a.push(i),a.push(d),a.push(e),a.push(f),a.push(g),a.push(h);for(var k=b.length-1;k>=0;k--);return a},a.prototype.move=function(){if(this.grid.canMove&&playerTurn&&!isMoving){if(Math.round(this.grid.movableSprite.x)===Math.round(this.grid.marker.x)?Math.round(this.grid.movableSprite.y)<Math.round(this.grid.marker.y)?this.grid.move(this.grid.movableLayers[0],"down"):this.grid.move(this.grid.movableLayers[0],"up"):Math.round(this.grid.movableSprite.y)===Math.round(this.grid.marker.y)?Math.round(this.grid.movableSprite.x)<Math.round(this.grid.marker.x)?this.grid.move(this.grid.movableLayers[0],"right"):this.grid.move(this.grid.movableLayers[0],"left"):Math.round(this.grid.movableSprite.y)<Math.round(this.grid.marker.y)&&Math.round(this.grid.movableSprite.x)>Math.round(this.grid.marker.x)?this.grid.move(this.grid.movableLayers[0],"bottomleft"):Math.round(this.grid.movableSprite.y)>Math.round(this.grid.marker.y)&&Math.round(this.grid.movableSprite.x)>Math.round(this.grid.marker.x)?this.grid.move(this.grid.movableLayers[0],"topleft"):Math.round(this.grid.movableSprite.y)>Math.round(this.grid.marker.y)&&Math.round(this.grid.movableSprite.x)<Math.round(this.grid.marker.x)?this.grid.move(this.grid.movableLayers[0],"topright"):Math.round(this.grid.movableSprite.y)<Math.round(this.grid.marker.y)&&Math.round(this.grid.movableSprite.x)<Math.round(this.grid.marker.x)&&this.grid.move(this.grid.movableLayers[0],"bottomright"),this.grid.checkLayer(this.grid.marker.x,this.grid.marker.y,3,this.grid.finalLayers)&&this.quitGame("play",!1),this.grid.checkLayer(this.grid.marker.x,this.grid.marker.y,4,this.grid.collectableLayers)){var a=this.grid.collect(this.grid.marker.x,this.grid.marker.y,this.grid.collectableLayers,4);SCORE+=10;for(var b=a.length-1;b>=0;b--){var c=0;c=gameWidth>gameHeight?.05*gameHeight:.05*gameWidth;var d=a[b],e=.5*c/d.width,f=game.add.tween(d.scale);f.to({x:e,y:e},250,Phaser.Easing.Linear.None),f.start();var g=game.add.tween(d);g.onStart.add(function(){isMoving=!0}),g.onComplete.add(function(){isMoving=!1}),g.to({x:160+e*d.width*powerUps,y:.25*c},250,Phaser.Easing.Linear.None,!1,0,0,!1),g.start(),this.TilePowerUpsG.add(d),powerUps++}}for(var b=this.grid.enemiesLayers.length-1;b>=0;b--)this.grid.enemiesLayers[b].callAll("turn");for(var b=this.grid.enemiesLayers.length-1;b>=0;b--)this.grid.enemiesLayers[b].callAll("checkAwake")}},PlayS=a}();var gameWidth,gameHeight,isMoving,level,powerUps,playerTurn,BUSTED,COLORS,SCORE,SIGNIN,BootS,PreloaderS,MainMenuS,PlayS,TutorialS,CreditsS,LeaderBoardsS,game,WebFontConfig;WebFontConfig={google:{families:["Source+Code+Pro::latin"]}},function(){var a=document.createElement("script");a.src=("https:"==document.location.protocol?"https":"http")+"://ajax.googleapis.com/ajax/libs/webfont/1/webfont.js",a.type="text/javascript",a.async="true";var b=document.getElementsByTagName("script")[0];b.parentNode.insertBefore(a,b)}(),window.onload=function(){gameWidth=window.innerWidth,gameHeight=window.innerHeight,isMoving=!1,BUSTED=!1,playerTurn=!0,level=1,powerUps=0,SCORE=0,COLORS=Phaser.Color.HSVColorWheel(),game=new Phaser.Game(gameWidth,gameHeight,Phaser.AUTO,"gameContainer"),game.state.add("boot",BootS),game.state.add("preloader",PreloaderS),game.state.add("credits",CreditsS),game.state.add("leaderboards",LeaderBoardsS),game.state.add("tutorial",TutorialS),game.state.add("mainmenu",MainMenuS),game.state.add("play",PlayS),game.state.start("boot")};